...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpPaisSunat: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "País Sunat";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsPaisSunatMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsPaisSunatMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
