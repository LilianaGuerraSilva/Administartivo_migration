...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpConveniosSunat: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Convenios Sunat";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsConveniosSunatMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsConveniosSunatMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpConveniosSunat
