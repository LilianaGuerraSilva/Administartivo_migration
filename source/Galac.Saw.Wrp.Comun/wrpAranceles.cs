...
namespace Galac.Saw.Wrp.Impuesto {
    ...
    public class wrpAranceles : System.EnterpriseServices.ServicedComponent, IWrpArancelesVb {
        ...
        private void RegistraCliente() {
            _Reglas = new Galac.Comun.Brl.Impuesto.clsArancelesNav();
        }
        ...
        string IWrpArancelesVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.Impuesto.clsArancelesMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
