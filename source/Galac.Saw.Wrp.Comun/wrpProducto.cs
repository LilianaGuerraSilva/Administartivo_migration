...
namespace Galac.Saw.Wrp.LeyCosto {
    ...
    public class wrpProducto: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
#region Variables
        string _Title = "Producto";
#endregion //Variables
#region Propiedades
...
#region Miembros de IWrpMfVb
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenu insMenu = new Galac.Comun.Uil.LeyCosto .clsProductoMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.LeyCosto .clsProductoMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
