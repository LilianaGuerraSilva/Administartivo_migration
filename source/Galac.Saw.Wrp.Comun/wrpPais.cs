...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpPais: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "País";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsPaisMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsPaisMenu.ChoosePaisFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
