...
namespace Galac.Saw.Wrp.LeyCosto {
    ...
    public class wrpCriterioDeDistribucion: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Criterios De Distribución";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenu insMenu = new Galac.Comun.Uil.LeyCosto.clsCriterioDeDistribucionMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.LeyCosto.clsCriterioDeDistribucionMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpCriterioDeDistribucion
