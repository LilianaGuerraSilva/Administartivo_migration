...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpCIIU: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "C.I.I.U.";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsCIIUMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsCIIUMenu.ChooseCIIU(ref vXmlDocument, vSearchValues, vFixedValues)) {
