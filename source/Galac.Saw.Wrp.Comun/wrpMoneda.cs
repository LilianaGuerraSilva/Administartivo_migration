...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpMoneda: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Moneda";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
           try {
              ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsMonedaMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
           ...
           try {
              ...
              if(Galac.Comun.Uil.TablasGen.clsMonedaMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpMunicipio

} //End of namespace Galac.Saw.Wrp.TablasGen
