...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpMunicipioCiudad: System.EnterpriseServices.ServicedComponent, IWrpVb {
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsMunicipioCiudadMenu.ChooseMunicipioCiudadFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpMunicipioCiudad
