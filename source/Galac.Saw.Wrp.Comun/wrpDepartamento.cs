...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpDepartamento : System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Departamento";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsDepartamentoMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsDepartamentoMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
