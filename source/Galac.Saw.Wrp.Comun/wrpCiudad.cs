...
namespace Galac.Saw.Wrp.TablasGen {
    ...
    public class wrpCiudad: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Ciudad";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Comun.Uil.TablasGen.clsCiudadMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Comun.Uil.TablasGen.clsCiudadMenu.ChooseCiudadFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
