...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CxPComprasPlanillaIVAMngViewModel))]
    public class CxPComprasPlanillaIVAMngViewModel : LibMngViewModel<CxPComprasPlanillaIVAViewModel, PlanillaDeIVAStt> {
        ...
        public CxPComprasPlanillaIVAMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CxPComprasPlanillaIVAViewModel CreateNewElement(PlanillaDeIVAStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CxPComprasPlanillaIVAViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<PlanillaDeIVAStt>, IList<PlanillaDeIVAStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CxPComprasPlanillaIVAViewModel vViewModel = new CxPComprasPlanillaIVAViewModel(new PlanillaDeIVAStt(), eAccionSR.Modificar);
