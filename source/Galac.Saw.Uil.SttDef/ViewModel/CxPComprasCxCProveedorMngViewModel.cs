...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CxPComprasCxCProveedorMngViewModel))]
    public class CxPComprasCxCProveedorMngViewModel : LibMngViewModel<CxPComprasCxCProveedorViewModel, CxPProveedorPagosStt> {
        ...
        public CxPComprasCxCProveedorMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CxPComprasCxCProveedorViewModel CreateNewElement(CxPProveedorPagosStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CxPComprasCxCProveedorViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<CxPProveedorPagosStt>, IList<CxPProveedorPagosStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CxPComprasCxCProveedorViewModel vViewModel = new CxPComprasCxCProveedorViewModel(new CxPProveedorPagosStt(), eAccionSR.Modificar);
