...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(FacturaImpresionMngViewModel))]
    public class FacturaImpresionMngViewModel : LibMngViewModel<FacturaImpresionViewModel, ImpresiondeFacturaStt> {

        #region Propiedades

        public override string ModuleName {
            get { return "2.3.- Impresión de Factura"; }
        }
        ...
        public FacturaImpresionMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override FacturaImpresionViewModel CreateNewElement(ImpresiondeFacturaStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new FacturaImpresionViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<ImpresiondeFacturaStt>, IList<ImpresiondeFacturaStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                FacturaImpresionViewModel vViewModel = new FacturaImpresionViewModel(new ImpresiondeFacturaStt(), eAccionSR.Modificar);
