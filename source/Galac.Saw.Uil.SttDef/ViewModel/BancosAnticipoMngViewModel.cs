...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(BancosAnticipoMngViewModel))]
    public class BancosAnticipoMngViewModel : LibMngViewModel<BancosAnticipoViewModel, AnticipoStt> {
        ...
        public BancosAnticipoMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override BancosAnticipoViewModel CreateNewElement(AnticipoStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new BancosAnticipoViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<AnticipoStt>, IList<AnticipoStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                BancosAnticipoViewModel vViewModel = new BancosAnticipoViewModel(new AnticipoStt(), eAccionSR.Modificar);
