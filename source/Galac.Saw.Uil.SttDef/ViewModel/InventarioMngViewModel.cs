...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(InventarioMngViewModel))]
    public class InventarioMngViewModel : LibMngViewModel<InventarioViewModel, InventarioStt> {
        ...
        public InventarioMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override InventarioViewModel CreateNewElement(InventarioStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new InventarioViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<InventarioStt>, IList<InventarioStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                InventarioViewModel vViewModel = new InventarioViewModel(new InventarioStt(), eAccionSR.Modificar);
