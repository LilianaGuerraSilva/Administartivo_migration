...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(BancosMngViewModel))]
    public class BancosMngViewModel : LibMngViewModel<BancosViewModel, BancosStt> {
        ...
        public BancosMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override BancosViewModel CreateNewElement(BancosStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new BancosViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<BancosStt>, IList<BancosStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                BancosViewModel vViewModel = new BancosViewModel(new BancosStt(), eAccionSR.Modificar);
