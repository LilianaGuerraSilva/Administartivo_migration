...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CXCCobranzasMngViewModel))]
    public class CXCCobranzasMngViewModel : LibMngViewModel<CXCCobranzasViewModel, CobranzasStt> {
        ...
        public CXCCobranzasMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CXCCobranzasViewModel CreateNewElement(CobranzasStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CXCCobranzasViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<CobranzasStt>, IList<CobranzasStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CXCCobranzasViewModel vViewModel = new CXCCobranzasViewModel(new CobranzasStt(), eAccionSR.Modificar);
