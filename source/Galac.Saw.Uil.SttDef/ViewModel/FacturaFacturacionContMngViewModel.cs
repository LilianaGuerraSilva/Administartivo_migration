...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(FacturaFacturacionContMngViewModel))]
    public class FacturaFacturacionContMngViewModel : LibMngViewModel<FacturaFacturacionContViewModel, FacturacionContinuacionStt> {
        ...
        public FacturaFacturacionContMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override FacturaFacturacionContViewModel CreateNewElement(FacturacionContinuacionStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new FacturaFacturacionContViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<FacturacionContinuacionStt>, IList<FacturacionContinuacionStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                FacturaFacturacionContViewModel vViewModel = new FacturaFacturacionContViewModel(new FacturacionContinuacionStt(), eAccionSR.Modificar);
