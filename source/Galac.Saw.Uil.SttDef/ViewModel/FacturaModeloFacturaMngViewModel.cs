...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(FacturaModeloFacturaMngViewModel))]
    public class FacturaModeloFacturaMngViewModel : LibMngViewModel<FacturaModeloFacturaViewModel, ModeloDeFacturaStt> {
        ...
        public FacturaModeloFacturaMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override FacturaModeloFacturaViewModel CreateNewElement(ModeloDeFacturaStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new FacturaModeloFacturaViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<ModeloDeFacturaStt>, IList<ModeloDeFacturaStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                FacturaModeloFacturaViewModel vViewModel = new FacturaModeloFacturaViewModel(new ModeloDeFacturaStt(), eAccionSR.Modificar);
