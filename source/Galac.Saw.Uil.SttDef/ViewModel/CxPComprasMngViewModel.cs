...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CxPComprasMngViewModel))]
    public class CxPComprasMngViewModel : LibMngViewModel<CxPComprasViewModel, ComprasStt> {
        ...
        public CxPComprasMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CxPComprasViewModel CreateNewElement(ComprasStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CxPComprasViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<ComprasStt>, IList<ComprasStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CxPComprasViewModel vViewModel = new CxPComprasViewModel(new ComprasStt(), eAccionSR.Modificar);
