...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CotizacionMngViewModel))]
    public class CotizacionMngViewModel : LibMngViewModel<CotizacionViewModel, CotizacionStt> {
        ...
        public CotizacionMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CotizacionViewModel CreateNewElement(CotizacionStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CotizacionViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<CotizacionStt>, IList<CotizacionStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CotizacionViewModel vViewModel = new CotizacionViewModel(new CotizacionStt(), eAccionSR.Modificar);
