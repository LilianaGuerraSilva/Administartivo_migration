...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CXCCobranzasComisionesMngViewModel))]
    public class CXCCobranzasComisionesMngViewModel : LibMngViewModel<CXCCobranzasComisionesViewModel, ComisionesStt> {
        ...
        public CXCCobranzasComisionesMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CXCCobranzasComisionesViewModel CreateNewElement(ComisionesStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CXCCobranzasComisionesViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<ComisionesStt>, IList<ComisionesStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CXCCobranzasComisionesViewModel vViewModel = new CXCCobranzasComisionesViewModel(new ComisionesStt(), eAccionSR.Modificar);
