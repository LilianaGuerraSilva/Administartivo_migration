...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(FacturaFacturacionMngViewModel))]
    public class FacturaFacturacionMngViewModel : LibMngViewModel<FacturaFacturacionViewModel, FacturacionStt> {
        ...
        public FacturaFacturacionMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override FacturaFacturacionViewModel CreateNewElement(FacturacionStt model, LibGalac.Aos.Base.eAccionSR valAction) {
           return new FacturaFacturacionViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<FacturacionStt>, IList<FacturacionStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                FacturaFacturacionViewModel vViewModel = new FacturaFacturacionViewModel(new FacturacionStt(), eAccionSR.Modificar);
