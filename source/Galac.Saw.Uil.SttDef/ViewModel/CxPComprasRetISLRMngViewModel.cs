...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CxPComprasRetISLRMngViewModel))]
    public class CxPComprasRetISLRMngViewModel : LibMngViewModel<CxPComprasRetISLRViewModel, RetencionISLRStt> {
        ...
        public CxPComprasRetISLRMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CxPComprasRetISLRViewModel CreateNewElement(RetencionISLRStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CxPComprasRetISLRViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<RetencionISLRStt>, IList<RetencionISLRStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CxPComprasRetISLRViewModel vViewModel = new CxPComprasRetISLRViewModel(new RetencionISLRStt(), eAccionSR.Modificar);
