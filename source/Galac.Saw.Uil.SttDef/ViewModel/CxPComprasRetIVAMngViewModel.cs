...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CxPComprasRetIVAMngViewModel))]
    public class CxPComprasRetIVAMngViewModel : LibMngViewModel<CxPComprasRetIVAViewModel, RetencionIVAStt> {
        ...
        public CxPComprasRetIVAMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CxPComprasRetIVAViewModel CreateNewElement(RetencionIVAStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CxPComprasRetIVAViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<RetencionIVAStt>, IList<RetencionIVAStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CxPComprasRetIVAViewModel vViewModel = new CxPComprasRetIVAViewModel(new RetencionIVAStt(), eAccionSR.Modificar);
