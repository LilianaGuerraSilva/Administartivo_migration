...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(FacturaCamposDefiniblesMngViewModel))]
    public class FacturaCamposDefiniblesMngViewModel : LibMngViewModel<FacturaCamposDefiniblesViewModel, CamposDefiniblesStt> {
        ...
        public FacturaCamposDefiniblesMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override FacturaCamposDefiniblesViewModel CreateNewElement(CamposDefiniblesStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new FacturaCamposDefiniblesViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<CamposDefiniblesStt>, IList<CamposDefiniblesStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                FacturaCamposDefiniblesViewModel vViewModel = new FacturaCamposDefiniblesViewModel(new CamposDefiniblesStt(), eAccionSR.Modificar);
