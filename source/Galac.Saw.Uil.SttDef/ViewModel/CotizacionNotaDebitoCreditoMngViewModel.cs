...
namespace Galac.Saw.Uil.SttDef.ViewModel {
    ...
    [LibMefInstallValuesMetadata(typeof(CotizacionNotaDebitoCreditoMngViewModel))]
    public class CotizacionNotaDebitoCreditoMngViewModel : LibMngViewModel<CotizacionNotaDebitoCreditoViewModel, NotasDebitoCreditoEntregaStt> {
        ...
        public CotizacionNotaDebitoCreditoMngViewModel() {
            Title = "Buscar " + ModuleName;
        }
        #endregion


        protected override CotizacionNotaDebitoCreditoViewModel CreateNewElement(NotasDebitoCreditoEntregaStt model, LibGalac.Aos.Base.eAccionSR valAction) {
            return new CotizacionNotaDebitoCreditoViewModel();
        }

        protected override LibGalac.Aos.Base.ILibBusinessComponentWithSearch<IList<NotasDebitoCreditoEntregaStt>, IList<NotasDebitoCreditoEntregaStt>> GetBusinessComponent() {
            return null;
        }
        ...
        private void InitializarViewModel(eAccionSR accion) {
            try {
                CotizacionNotaDebitoCreditoViewModel vViewModel = new CotizacionNotaDebitoCreditoViewModel(new NotasDebitoCreditoEntregaStt(), eAccionSR.Modificar);
