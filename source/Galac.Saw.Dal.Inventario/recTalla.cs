...
namespace Galac.Saw.Dal.Inventario {
    ...
    public class recTalla {
        ...
        public recTalla Clone() {
            recTalla vResult = new recTalla();
        ...
        public void Fill(XmlDocument refResulset, bool valSetCurrent) {
            ...
            if (valSetCurrent && insParser.Count() > 0) {
                ...
                CodigoTalla = insParser.GetString(0, "CodigoTalla", CodigoTalla);
                DescripcionTalla = insParser.GetString(0, "DescripcionTalla", DescripcionTalla);
