    ...
    public sealed class clsProveedorList: LibUicMF, ILibDbSearchModule {
        ...
        private void RegistraCliente() {
            if (WorkWithRemoting) {
                ...
                _Reglas = new Galac.Adm.Brl.CajaChica.clsProveedorNav();
            }
        }
        ...
        LibGalac.Aos.Base.Report.ILibReportInfo ILibDbSearch.GetDataRetrievesInstance() {
            //return new Galac.Adm.Brl.CajaChica.Reportes.clsProveedorRpt();
            return null;
        }
        ...
        public static bool ChooseProveedor(System.Windows.Window refOwner, ref XmlDocument refXmlDocument, List<LibSearchDefaultValues> valSearchCriteria, List<LibSearchDefaultValues> valFixedCriteria) {
            bool vResult = false;
            //vResult = LibFkRetrieval.ChooseRecord(refOwner, new Galac.Adm.Uil.CajaChica.Sch.GSProveedorSch(), ref refXmlDocument, valSearchCriteria, valFixedCriteria, "Proveedor", new clsProveedorList(null, null));
            return vResult;
        }
        ...
        public static bool ChooseTablaRetencion(System.Windows.Window refOwner, ref XmlDocument refXmlDocument, List<LibSearchDefaultValues> valSearchCriteria, List<LibSearchDefaultValues> valFixedCriteria) {
            bool vResult = false;
        //    vResult = LibFkRetrieval.ChooseRecord(refOwner, new Galac.dbo.Uil.TablaRetencion.Sch.GSTablaRetencionSch(), ref refXmlDocument, valSearchCriteria, valFixedCriteria, "Tabla Retencion", new clsProveedorList(null, null));
            return vResult;
        }
        ...
        public static bool ChooseCuenta(System.Windows.Window refOwner, ref XmlDocument refXmlDocument, List<LibSearchDefaultValues> valSearchCriteria, List<LibSearchDefaultValues> valFixedCriteria) {
            bool vResult = false;
          //  vResult = LibFkRetrieval.ChooseRecord(refOwner, new Galac.dbo.Uil.Cuenta.Sch.GSCuentaSch(), ref refXmlDocument, valSearchCriteria, valFixedCriteria, "Cuenta", new clsProveedorList(null, null));
            return vResult;
        }
