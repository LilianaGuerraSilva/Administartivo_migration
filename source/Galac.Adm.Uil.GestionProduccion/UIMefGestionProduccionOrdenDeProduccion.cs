...
namespace Galac.Adm.Uil. GestionProduccion {
    [LibMefUilComponentMetadata(typeof(UIMefGestionProduccionOrdenDeProduccion), "Adm")]
    public class UIMefGestionProduccionOrdenDeProduccion : ILibMefUilComponent {
        #region Variables
        private OrdenDeProduccionMngViewModel _ViewModel;
        ...
        public UIMefGestionProduccionOrdenDeProduccion() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new OrdenDeProduccionMngViewModel();
                }
    ...
    } //End of class UIMef GestionProduccionOrdenDeProduccion
