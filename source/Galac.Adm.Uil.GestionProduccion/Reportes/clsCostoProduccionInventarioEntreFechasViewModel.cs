    ...
    public class clsCostoProduccionInventarioEntreFechasViewModel : LibInputRptViewModelBase<OrdenDeProduccion> {
        ...
        */
        ...
        public override string DisplayName {
            get { return "Costos de Inventario"; }
        }
        ...
        */
        ...
        private void ExecuteChooseCodigoArticuloInventarioCommand(string valCodigo) {
            try {
                ...
                ConexionCodigoArticuloInventario = ChooseRecord<FkOrdenProduccionArticuloProducirViewModel>("Orden de Producción Artículo para reportes", vDefaultCriteria, vFixedCriteria, string.Empty);
