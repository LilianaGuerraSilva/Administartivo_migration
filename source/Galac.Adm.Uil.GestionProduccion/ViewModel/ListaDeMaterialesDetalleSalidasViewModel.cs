    ...
    public class ListaDeMaterialesDetalleSalidasViewModel : LibInputDetailViewModelMfc<ListaDeMaterialesDetalleSalidas> {
        ...
        private ValidationResult MermaNormalValidating() {
            ...
            if ((Action == eAccionSR.Insertar || Action == eAccionSR.Modificar) && (MermaNormal >= 0)) {
                ...
                vResult = new ValidationResult("La cantidad de Merma Normal (Salidas) debe ser mayor o igual a 0. ");
            }
            return vResult;
        }
        ...
        private ValidationResult PorcentajeMermaNormalValidating() {
            ...
            if ((Action == eAccionSR.Insertar || Action == eAccionSR.Modificar) && (PorcentajeMermaNormal >= 0)) {
                ...
                vResult = new ValidationResult("La Porcentaje de Merma Normal (Salidas) debe ser mayor o igual a 0.");
            }
            return vResult;
        }
