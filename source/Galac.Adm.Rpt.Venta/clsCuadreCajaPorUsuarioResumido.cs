...
namespace Galac.Adm.Rpt.Venta {
    ...
    public class clsCuadreCajaPorUsuarioResumido: LibRptBaseMfc {
        #region Propiedades
        ...
        public static string ReportName {
            get { return new dsrCuadreCajaPorUsuarioResumido().ReportTitle(); }
        }

        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsCuadreCajaPorUsuarioResumido.ReportName;
            if (UseExternalRpx) {
        ...
        public override void SendReportToDevice() {
            ...
            dsrCuadreCajaPorUsuarioResumido vRpt = new dsrCuadreCajaPorUsuarioResumido();
            if (Data.Rows.Count < 1) {
                throw new GalacException("No existen datos para mostrar", eExceptionManagementType.Alert);
            }
            if (vRpt.ConfigReport(Data, vParams)) {
                LibReport.SendReportToDevice(vRpt, 1, PrintingDevice, clsCuadreCajaPorUsuarioResumido.ReportName, true, ExportFileFormat, "", false);
            }
