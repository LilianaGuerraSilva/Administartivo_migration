    ...
    public partial class dsrComisionDeVendedoresPorCobranzaMontoResumido : DataDynamics.ActiveReports.ActiveReport {
        ...
        public bool ConfigReport(DataTable valDataSource, Dictionary<string, string> valParameters) {
            ...
            if (LibReport.ConfigDataSource(this, valDataSource)) {
				...
				LibReport.ConfigGroupHeader(this, "GHSecNotaDeCambio", "", GroupKeepTogether.FirstDetail, RepeatStyle.OnPageIncludeNoDetail, true, NewPage.None);
				LibReport.ConfigGroupHeader(this, "GHSecMonedaCobranza", "MonedaCobranza", GroupKeepTogether.FirstDetail, RepeatStyle.OnPageIncludeNoDetail, true, NewPage.None);
				LibReport.ConfigGroupHeader(this, "GHSecVendedor", "CodigoDelVendedor", GroupKeepTogether.None,RepeatStyle.OnPage, true, NewPage.None);
