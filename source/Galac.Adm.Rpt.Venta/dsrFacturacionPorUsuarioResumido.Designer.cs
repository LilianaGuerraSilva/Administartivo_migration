namespace Galac.Adm.Rpt.Venta
{
    ...
    /// </summary>
    partial class dsrFacturacionPorUsuarioResumido
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(dsrFacturacionPorUsuarioResumido));
			...
			this.txtPorcentajeDescuentoFactura.Text = "txtPorcentajeDescuentoFactura";
			this.txtPorcentajeDescuentoFactura.Top = 0F;
			this.txtPorcentajeDescuentoFactura.Width = 0.4375005F;
			// 
			// txtCambio
			// 
			...
			this.lblTituloDelReporte.Text = "Facturación por Usuario - Resumido";
			...
			this.lblFechaInicialYFinal.Top = 0.53125F;
            ...
            this.lblNota});
			this.PageFooter.Height = 0.188F;
			this.PageFooter.Name = "PageFooter";
			// 
			// lblNota
			// 
			this.lblNota.Height = 0.188F;
			...
			this.lblNumeroComprobante.Width = 0.833F;
			// 
			// lblNumero
			// 
			...
			// 
			// dsrFacturacionPorUsuarioResumido
			// 
