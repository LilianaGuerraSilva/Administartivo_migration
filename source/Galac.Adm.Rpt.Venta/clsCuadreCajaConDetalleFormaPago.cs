...
namespace Galac.Adm.Rpt.Venta {
    ...
    public class clsCuadreCajaConDetalleFormaPago: LibRptBaseMfc {
        #region Propiedades
        ...
        public clsCuadreCajaConDetalleFormaPago(ePrintingDevice initPrintingDevice, eExportFileFormat initExportFileFormat, LibXmlMemInfo initAppMemInfo, LibXmlMFC initMfc)
        ...
        public static string ReportName {
            get { return new dsrCuadreCajaConDetalleFormaPago().ReportTitle(); }
        }

        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsCuadreCajaConDetalleFormaPago.ReportName;
            if (UseExternalRpx) {
        ...
        public override void SendReportToDevice() {
            ...
            dsrCuadreCajaConDetalleFormaPago vRpt = new dsrCuadreCajaConDetalleFormaPago();
            if (Data.Rows.Count < 1) {
                throw new GalacException("No existen datos para mostrar", eExceptionManagementType.Alert);
            }
            if (vRpt.ConfigReport(Data, vParams)) {
                LibReport.SendReportToDevice(vRpt, 1, PrintingDevice, clsCuadreCajaConDetalleFormaPago.ReportName, true, ExportFileFormat, "", false);
            }
