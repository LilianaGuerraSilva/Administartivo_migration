...
namespace Galac.Adm.Rpt.Venta {
    ...
    public class clsComisionDeVendedoresPorCobranzaMontoResumido:LibRptBaseMfc {
        #region Propiedades
        ...
        public static string ReportName {
            get { return new dsrComisionDeVendedoresPorCobranzaMontoResumido().ReportTitle(); }
        }

        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsComisionDeVendedoresPorCobranzaMontoResumido.ReportName;
            if (UseExternalRpx) {
        ...
        public override void SendReportToDevice() {
            ...
            if (Data.Rows.Count < 1 ) {
                ...
                dsrComisionDeVendedoresPorCobranzaMontoResumido vRpt = new dsrComisionDeVendedoresPorCobranzaMontoResumido();
                ...
                if (vRpt.ConfigReport(Data, vParams)) {
                    LibReport.SendReportToDevice(vRpt, 1, PrintingDevice, clsComisionDeVendedoresPorCobranzaMontoResumido.ReportName, true, ExportFileFormat, "", false);
                }
            }
