...
namespace Galac.Adm.Rpt.Venta {
    ...
    /// </summary>
    public partial class dsrFacturacionEntreFechasVerificado : DataDynamics.ActiveReports.ActiveReport {
        #region Variables
        ...
        public dsrFacturacionEntreFechasVerificado()
            : this(false, string.Empty) {
        }

        public dsrFacturacionEntreFechasVerificado(bool initUseExternalRpx, string initRpxFileName) {
            InitializeComponent();
        ...
        public string ReportTitle() {
            return "Facturación Entre Fechas. SENIAT1 - Revisar Título";
        }
