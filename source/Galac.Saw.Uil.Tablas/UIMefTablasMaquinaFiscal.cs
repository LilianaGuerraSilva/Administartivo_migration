...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasMaquinaFiscal), "Tablas")]
    public class UIMefTablasMaquinaFiscal : ILibMefUilComponent {
        #region Variables
        private MaquinaFiscalMngViewModel _ViewModel;
        ...
        public UIMefTablasMaquinaFiscal() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new MaquinaFiscalMngViewModel();
            }
        }
    ...
    } //End of class UIMefTablasMaquinaFiscal
