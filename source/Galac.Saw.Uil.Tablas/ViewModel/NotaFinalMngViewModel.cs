...
namespace Galac.Saw.Uil.Tablas.ViewModel {
    ...
    public class NotaFinalMngViewModel : LibMngViewModelMfc<NotaFinalViewModel, NotaFinal> {
        #region Propiedades
        ...
        */
        ...
        public NotaFinalMngViewModel()
            : base(LibGlobalValues.Instance.GetAppMemInfo(), LibGlobalValues.Instance.GetMfcInfo()) {
            Title = "Buscar " + ModuleName;
            OrderByMember = "ConsecutivoCompania, CodigoDeLaNota";
        #region Codigo Ejemplo
        /* Codigo de Ejemplo
        ...
        */
        ...
        protected override NotaFinalViewModel CreateNewElement(NotaFinal valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new NotaFinal();
            }
            return new NotaFinalViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_NotaFinal_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
       ...
       protected override bool CanExecuteSearchCommand() {
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(NotaFinal valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class NotaFinalMngViewModel
