...
namespace Galac.Saw.Uil.Tablas.ViewModel {
    ...
    public class ZonaCobranzaMngViewModel : LibMngViewModelMfc<ZonaCobranzaViewModel, ZonaCobranza> {
        #region Propiedades
        ...
        */
        ...
        public ZonaCobranzaMngViewModel()
        ...
        */
        ...
        protected override ZonaCobranzaViewModel CreateNewElement(ZonaCobranza valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new ZonaCobranza();
            }
            return new ZonaCobranzaViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_ZonaCobranza_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(ZonaCobranza valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class ZonaCobranzaMngViewModel
