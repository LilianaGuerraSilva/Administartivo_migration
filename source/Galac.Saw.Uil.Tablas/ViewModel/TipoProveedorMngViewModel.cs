...
namespace Galac.Saw.Uil.Tablas.ViewModel {
    ...
    public class TipoProveedorMngViewModel : LibMngViewModelMfc<TipoProveedorViewModel, TipoProveedor> {
        #region Propiedades
        ...
        */
        ...
        public TipoProveedorMngViewModel()
            : base(LibGlobalValues.Instance.GetAppMemInfo(), LibGlobalValues.Instance.GetMfcInfo()) {
            Title = "Buscar " + ModuleName;
            OrderByMember = "ConsecutivoCompania, Nombre";
        #region Codigo Ejemplo
        /* Codigo de Ejemplo
        ...
        */
        ...
        protected override TipoProveedorViewModel CreateNewElement(TipoProveedor valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new TipoProveedor();
            }
            return new TipoProveedorViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_TipoProveedor_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        protected override ILibReportInfo GetDataRetrievesInstance() {
            return new clsTipoProveedorRpt();
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(TipoProveedor valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class TipoProveedorMngViewModel
