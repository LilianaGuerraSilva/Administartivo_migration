...
namespace Galac.Saw.Uil.Tablas.ViewModel {
    ...
    public class CondicionesDePagoMngViewModel : LibMngViewModelMfc<CondicionesDePagoViewModel, CondicionesDePago> {
        #region Propiedades
        ...
        public CondicionesDePagoMngViewModel()
        ...
        */
        ...
        protected override CondicionesDePagoViewModel CreateNewElement(CondicionesDePago valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new CondicionesDePago();
            }
            return new CondicionesDePagoViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_CondicionesDePago_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(CondicionesDePago valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class CondicionesDePagoMngViewModel
