...
namespace Galac.Saw.Uil.Tablas.ViewModel {
    ...
    public class PropAnalisisVencMngViewModel : LibMngViewModel<PropAnalisisVencViewModel, PropAnalisisVenc> {
        #region Propiedades
        ...
        */
        ...
        public PropAnalisisVencMngViewModel() {
            Title = "Buscar " + ModuleName;
            OrderByMember = "SecuencialUnique0";
        #region Codigo Ejemplo
        /* Codigo de Ejemplo
        ...
        */
        ...
        protected override PropAnalisisVencViewModel CreateNewElement(PropAnalisisVenc valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new PropAnalisisVenc();
            }
            return new PropAnalisisVencViewModel(vNewModel, valAction);
        }
        ...
        protected override ILibReportInfo GetDataRetrievesInstance() {
            return new clsPropAnalisisVencRpt();
        }
        ...
        */
        ...
        protected override bool HasAccessToModule() {
            bool vResult = false;
            vResult = (LibSecurityManager.CurrentUserHasAccessTo("Tablas", "Modificar") ||
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(PropAnalisisVenc valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class PropAnalisisVencMngViewModel
