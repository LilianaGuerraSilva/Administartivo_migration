...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasUnidadDeVenta), "Saw")]
    public class UIMefTablasUnidadDeVenta : ILibMefUilComponent {
        #region Variables
        private UnidadDeVentaMngViewModel _ViewModel;
        ...
        public UIMefTablasUnidadDeVenta() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new UnidadDeVentaMngViewModel();
            }
        }
    ...
    } //End of class UIMefTablasUnidadDeVenta
