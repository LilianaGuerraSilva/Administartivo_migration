...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasRutaDeComercializacion), "Saw")]
    public class UIMefTablasRutaDeComercializacion : ILibMefUilComponent {
        #region Variables
        private RutaDeComercializacionMngViewModel _ViewModel;
        ...
        public UIMefTablasRutaDeComercializacion() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new RutaDeComercializacionMngViewModel();
                }
    ...
    } //End of class UIMefTablasRutaDeComercializacion
