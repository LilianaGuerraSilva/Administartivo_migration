...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasCondicionesDePago), "Tablas")]
    public class UIMefTablasCondicionesDePago : ILibMefUilComponent {
        #region Variables
        private CondicionesDePagoMngViewModel _ViewModel;
        ...
        public UIMefTablasCondicionesDePago() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CondicionesDePagoMngViewModel();
                }
    ...
    } //End of class UIMefTablasCondicionesDePago
