...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasNotaFinal), "Tablas")]
    public class UIMefTablasNotaFinal : ILibMefUilComponent {
        #region Variables
        private NotaFinalMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new NotaFinalMngViewModel();
            }
        }
    ...
    } //End of class UIMefTablasNotaFinal
