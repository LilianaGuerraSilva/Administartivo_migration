...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasImpuestoBancario), "Tablas")]
    public class UIMefTablasImpuestoBancario : ILibMefUilComponent {
        #region Variables
        private ImpuestoBancarioMngViewModel _ViewModel;
        ...
        public UIMefTablasImpuestoBancario() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new ImpuestoBancarioMngViewModel();
                }
    ...
    } //End of class UIMefTablasImpuestoBancario
