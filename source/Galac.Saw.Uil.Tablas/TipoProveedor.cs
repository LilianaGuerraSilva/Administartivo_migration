...
namespace Galac.Saw.Uil.Tablas {
    public class TipoProveedor: LibMROMF {
        #region Variables
        ...
        public TipoProveedor(LibXmlMemInfo initAppMemoryInfo, LibXmlMFC initMfc):base(initAppMemoryInfo, initMfc) {
        }
        ...
        XmlReader ParseToXml(TipoProveedor valEntidad) {
            List<TipoProveedor> vListEntidades = new List<TipoProveedor>();
        ...
        public void FindAndSetObject(int valConsecutivoCompania, string valNombre) {
            ...
            XmlReader vXmlDoc = _Reglas.GetData(eProcessMessageType.SpName, "TipoProveedorGET", vParams.Get());
            Parse(vXmlDoc);
        }
