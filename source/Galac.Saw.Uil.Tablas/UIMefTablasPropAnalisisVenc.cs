...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasPropAnalisisVenc), "Saw")]
    public class UIMefTablasPropAnalisisVenc : ILibMefUilComponent {
        #region Variables
        private PropAnalisisVencMngViewModel _ViewModel;
        ...
        public string Name {
            ...
            get { return "Propiedad Análisis Vencimiento"; }
        }
        ...
        public UIMefTablasPropAnalisisVenc() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new PropAnalisisVencMngViewModel();
            }
        }
    ...
    } //End of class UIMefTablasPropAnalisisVenc
