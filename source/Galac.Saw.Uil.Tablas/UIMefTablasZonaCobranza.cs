...
namespace Galac.Saw.Uil.Tablas {
    [LibMefUilComponentMetadata(typeof(UIMefTablasZonaCobranza), "Tablas")]
    public class UIMefTablasZonaCobranza : ILibMefUilComponent {
        #region Variables
        private ZonaCobranzaMngViewModel _ViewModel;
        ...
        public UIMefTablasZonaCobranza() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new ZonaCobranzaMngViewModel();
            }
        }
    ...
    } //End of class UIMefTablasZonaCobranza
