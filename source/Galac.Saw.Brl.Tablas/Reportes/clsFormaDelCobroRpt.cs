...
namespace Galac.Saw.Brl.Tablas.Reportes {
    ...
    public class clsFormaDelCobroRpt: ILibReportInfo {
        #region Variables
        ...
        public clsFormaDelCobroRpt() {
            _PropertiesForReportList = new Dictionary<string, Dictionary<string, string>>();
            _PropertiesForReportList.Add("Forma Del Cobro", FormaDelCobroInfo());
        }
        #endregion //Constructores
        #region Metodos Generados

        private Dictionary<string, string> FormaDelCobroInfo() {
            Dictionary<string, string> vResult = new Dictionary<string, string>();
            vResult.Add("SpSearchName", "SAW.Gp_FormaDelCobroSCH");
    ...
    } //End of class clsFormaDelCobroRpt
