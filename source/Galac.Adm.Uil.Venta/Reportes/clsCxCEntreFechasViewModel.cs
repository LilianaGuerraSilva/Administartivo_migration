...
namespace Galac.Adm.Uil.Venta.Reportes {
    public class clsCxCEntreFechasViewModel : LibInputRptViewModelBase<CxC> {
        ...
        #region Propiedades
        public override string DisplayName { get { return "Cuentas por Cobrar entre fechas"; } }
        ...
        public bool IsVisibleMonedasActivas { get { return MonedaDelInforme == eMonedaDelInformeMM.EnDivisasYBolivaresEnDivisas; } }
        ...
        public bool IsVisibleTasaDeCambio { get { return MonedaDelInforme == eMonedaDelInformeMM.EnBolivares || MonedaDelInforme == eMonedaDelInformeMM.EnDivisasYBolivaresEnDivisas; } }
        ...
        void LlenarListaMonedaDelInforme() {
            ...
            ListaMonedaDelInforme.Add(eMonedaDelInformeMM.EnDivisasYBolivaresEnDivisas);
