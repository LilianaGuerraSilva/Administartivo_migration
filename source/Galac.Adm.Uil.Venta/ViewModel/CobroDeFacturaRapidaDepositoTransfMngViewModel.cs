...
namespace Galac.Adm.Uil.Venta.ViewModel {
    ...
    public class CobroDeFacturaRapidaDepositoTransfMngViewModel : LibMngMasterViewModelMfc<CobroDeFacturaRapidaDepositoTransfViewModel, CobroDeFacturaRapidaDepositoTransf> {
        #region Propiedades

        public override string ModuleName {
            get { return "Cobro Tarjeta de Deposito Transferencia"; }
        }
        #endregion //Propiedades
        #region Constructores

        public CobroDeFacturaRapidaDepositoTransfMngViewModel()
        ...
        */
        ...
        protected override CobroDeFacturaRapidaDepositoTransfViewModel CreateNewElement(CobroDeFacturaRapidaDepositoTransf valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new CobroDeFacturaRapidaDepositoTransf();
            }
            return new CobroDeFacturaRapidaDepositoTransfViewModel(vNewModel, valAction,true);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_CobroDeFacturaRapidaDepositoTransf_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        protected override ILibReportInfo GetDataRetrievesInstance() {
           // return new clsCobroDeFacturaRapidaDepositoTransfRpt();
            return null;
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(CobroDeFacturaRapidaDepositoTransf valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class CobroDeFacturaRapidaDepositoTransfMngViewModel
