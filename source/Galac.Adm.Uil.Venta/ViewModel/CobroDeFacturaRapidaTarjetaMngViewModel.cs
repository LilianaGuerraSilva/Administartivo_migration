...
namespace Galac.Adm.Uil.Venta.ViewModel {
    ...
    public class CobroDeFacturaRapidaTarjetaMngViewModel : LibMngMasterViewModelMfc<CobroDeFacturaRapidaTarjetaViewModel, CobroDeFacturaRapidaTarjeta> {
        #region Propiedades
        ...
        public CobroDeFacturaRapidaTarjetaMngViewModel()
        ...
        */
        ...
        protected override CobroDeFacturaRapidaTarjetaViewModel CreateNewElement(CobroDeFacturaRapidaTarjeta valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new CobroDeFacturaRapidaTarjeta();
            }
            return new CobroDeFacturaRapidaTarjetaViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_CobroDeFacturaRapidaTarjeta_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        protected override ILibReportInfo GetDataRetrievesInstance() {
           // return new clsCobroDeFacturaRapidaTarjetaRpt();
            return null ;
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(CobroDeFacturaRapidaTarjeta valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class CobroDeFacturaRapidaTarjetaMngViewModel
