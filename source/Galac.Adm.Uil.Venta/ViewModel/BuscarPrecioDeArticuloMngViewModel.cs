...
namespace Galac.Adm.Uil.Venta.ViewModel {
    ...
    public class BuscarPrecioDeArticuloMngViewModel : LibMngViewModelMfc<BuscarPrecioDeArticuloViewModel> {
        #region Propiedades
        ...
        public BuscarPrecioDeArticuloMngViewModel()
            : base(LibGlobalValues.Instance.GetAppMemInfo(), LibGlobalValues.Instance.GetMfcInfo()) {
            Title = "Buscar " + ModuleName;
            OrderByMember = "ConsecutivoCompania, Articulo";
        ...
        */
        ...
        protected override BuscarPrecioDeArticuloViewModel CreateNewElement(BuscarPrecioDeArticulo valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new BuscarPrecioDeArticulo();
            }
            return new BuscarPrecioDeArticuloViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_BuscarPrecioDeArticulo_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }

        protected override ILibBusinessComponentWithSearch<IList<BuscarPrecioDeArticulo>, IList<BuscarPrecioDeArticulo>> GetBusinessComponent() {
            return new clsBuscarPrecioDeArticuloNav();
        }

        protected override ILibReportInfo GetDataRetrievesInstance() {
            return new clsBuscarPrecioDeArticuloRpt();
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(BuscarPrecioDeArticulo valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class BuscarPrecioDeArticuloMngViewModel
