...
namespace Galac.Adm.Uil.Venta.ViewModel {
    public class CobroDeFacturaRapidaDepositoTransfDetalleViewModel : LibInputDetailViewModelMfc<CobroDeFacturaRapidaDepositoTransfDetalle> {
        ...
        public override string ModuleName {
            get { return "Punto de Venta Deposito Transferencia Detalle"; }
        }
        ...
        [LibRequired(ErrorMessage = "El campo Número de Referencia es requerido.")]
        [LibGridColum("Nro. de Referencia", eGridColumType.Generic, Width = 160, MaxLength = 20)]
       ...
       // [LibGridColum("Banco", eGridColumType.Generic, Width = 250, MaxLength = 250)]
        ...
        ////[LibRequired(ErrorMessage = "El campo Código del Banco del Punto de Venta es requerido.")]
        ////[LibGridColum("Punto De Venta", MaxLength = 100)]
        //[LibRequired(ErrorMessage = "El campo Código del Banco es requerido.")]
        ////[LibGridColum("Código Banco", MaxLength = 100)]
        ...
        [LibGridColum("Monto", eGridColumType.UDecimal, Width = 120, MaxLength = 80, BindingStringFormat = "N2")]
        ...
        public CobroDeFacturaRapidaDepositoTransfViewModel Master {
            get;
            set;
        }
        ...
        public CobroDeFacturaRapidaDepositoTransfDetalleViewModel()
            : base(new CobroDeFacturaRapidaDepositoTransfDetalle(), eAccionSR.Insertar, LibGlobalValues.Instance.GetAppMemInfo(), LibGlobalValues.Instance.GetMfcInfo()) {
        }
       public CobroDeFacturaRapidaDepositoTransfDetalleViewModel(CobroDeFacturaRapidaDepositoTransfViewModel initMaster, CobroDeFacturaRapidaDepositoTransfDetalle initModel, eAccionSR initAction)
        ...
        protected override void InitializeLookAndFeel(CobroDeFacturaRapidaDepositoTransfDetalle valModel) {
            base.InitializeLookAndFeel(valModel);
        }

        protected override ILibBusinessDetailComponent<IList<CobroDeFacturaRapidaDepositoTransfDetalle>, IList<CobroDeFacturaRapidaDepositoTransfDetalle>> GetBusinessComponent() {
            return new clsCobroDeFacturaRapidaDepositoTransfDetalleNav();
        }
