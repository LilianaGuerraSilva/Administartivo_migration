...
namespace Galac.Adm.Uil.Venta {
    [LibMefUilComponentMetadata(typeof(UIMefVentaCajaApertura),"Adm")]
    public class UIMefVentaCajaApertura:ILibMefUilComponent {
        #region Variables
        private CajaAperturaMngViewModel _ViewModel;
        private ContentControl _View;
        #endregion //Variables
        #region Propiedades

        public string Name {
            get { return "Configurar"; }
        }
        ...
        public ContentControl View {
            get {
                if (_View == null) {                    
                    _View = new GSSearchView() { DataContext = _ViewModel };                    
                }
                return _View;
            }            
        }
        ...
        public void InitializeIfNecessary() {
            try {
                if(!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CajaAperturaMngViewModel();
                }
    ...
    } //End of class UIMefVentaCajaApertura
