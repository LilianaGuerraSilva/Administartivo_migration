...
namespace Galac.Adm.Uil.Venta {
    public class clsCajaMenu: ILibMenu {
        #region Metodos Generados

        void ILibMenu.Ejecuta(eAccionSR valAction, int valUseInterop) {
            CajaMngViewModel vViewModel = new CajaMngViewModel();
        ...
        public static bool ChooseFromInterop(ref XmlDocument refXmlDocument, List<LibSearchDefaultValues> valSearchCriteria, List<LibSearchDefaultValues> valFixedCriteria) {
            return LibFKRetrievalHelper.ChooseRecord<FkCajaViewModel>("Caja Registradora", ref refXmlDocument, valSearchCriteria, valFixedCriteria, new clsCajaNav());
        }
        #endregion //Metodos Generados


    } //End of class clsCajaMenu
