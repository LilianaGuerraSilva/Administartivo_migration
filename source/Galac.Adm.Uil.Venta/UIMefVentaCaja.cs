...
namespace Galac.Adm.Uil.Venta {
    [LibMefUilComponentMetadata(typeof(UIMefVentaCaja), "Adm")]
    public class UIMefVentaCaja : ILibMefUilComponent {
        #region Variables
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CajaMngViewModel();
                }
