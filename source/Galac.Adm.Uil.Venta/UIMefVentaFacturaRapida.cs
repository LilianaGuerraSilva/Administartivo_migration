...
namespace Galac.Adm.Uil.Venta {
    [LibMefUilComponentMetadata(typeof(UIMefVentaFacturaRapida), "Adm")]
    public class UIMefVentaFacturaRapida : ILibMefUilComponent {
        #region Variables
        private FacturaRapidaMngViewModel _ViewModel;
        ...
        public UIMefVentaFacturaRapida() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new FacturaRapidaMngViewModel();
                }
