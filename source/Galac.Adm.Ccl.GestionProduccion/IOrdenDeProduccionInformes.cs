...
namespace Galac.Adm.Ccl. GestionProduccion {
    ...
    public interface IOrdenDeProduccionInformes {
        ...
        System.Data.DataTable BuildDetalleDeCostoDeProduccion(int valConsecutivoCompania, DateTime valFechaInicial, DateTime valFechaFinal, eSeleccionarPor valGeneradoPor, int valConsecutivoOrden);
    }
