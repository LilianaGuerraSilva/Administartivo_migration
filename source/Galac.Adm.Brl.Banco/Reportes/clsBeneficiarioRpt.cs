...
namespace Galac.Adm.Brl.Banco.Reportes {
    ...
    public class clsBeneficiarioRpt: ILibReportInfo {
        #region Variables
        ...
        public clsBeneficiarioRpt() {
            _PropertiesForReportList = new Dictionary<string, Dictionary<string, string>>();
            _PropertiesForReportList.Add("Beneficiario", BeneficiarioInfo());
        }
        #endregion //Constructores
        #region Metodos Generados

        private Dictionary<string, string> BeneficiarioInfo() {
            Dictionary<string, string> vResult = new Dictionary<string, string>();
            vResult.Add("SpSearchName", "Saw.Gp_BeneficiarioSCH");
    ...
    } //End of class clsBeneficiarioRpt
