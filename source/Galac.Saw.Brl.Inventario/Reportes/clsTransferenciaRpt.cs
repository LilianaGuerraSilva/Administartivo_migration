...
namespace Galac.Saw.Brl.Inventario.Reportes {
    ...
    public class clsTransferenciaRpt: ILibReportInfo {
        #region Variables
        ...
        public clsTransferenciaRpt() {
            _PropertiesForReportList = new Dictionary<string, Dictionary<string, string>>();
            _PropertiesForReportList.Add("Transferencia", TransferenciaInfo());
        }
        #endregion //Constructores
        #region Metodos Generados

        private Dictionary<string, string> TransferenciaInfo() {
            Dictionary<string, string> vResult = new Dictionary<string, string>();
            vResult.Add("SpSearchName", "Saw.Gp_TransferenciaSCH");
    ...
    } //End of class clsTransferenciaRpt
