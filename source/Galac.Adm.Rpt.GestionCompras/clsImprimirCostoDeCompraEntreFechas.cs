...
namespace Galac.Adm.Rpt.GestionCompras {
    ...
    public class clsImprimirCostoDeCompraEntreFechas: LibRptBaseMfc {
        #region Propiedades
        ...
        */
        ...
        public clsImprimirCostoDeCompraEntreFechas(ePrintingDevice initPrintingDevice, eExportFileFormat initExportFileFormat, LibXmlMemInfo initAppMemInfo, LibXmlMFC initMfc)
        ...
        */
        ...
        public static string ReportName {
            get { return new dsrImprimirCostoDeCompraEntreFechas().ReportTitle(); }
        }

        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsImprimirCostoDeCompraEntreFechas.ReportName;
            if (UseExternalRpx) {
        ...
        */
        ...
        public override void RunReport() {
            ...
            Data = vRpt.BuildImprimirCostoDeCompraEntreFechas(Mfc.GetInt("Compania"), FechaInicial, FechaFinal, LineasDeProductoCantidadAImprimir, CodigoProducto);
        }

        public override void SendReportToDevice() {
            WorkerReportProgress(90, "Configurando Informe...");
            Dictionary<string, string> vParams = GetConfigReportParameters();
            dsrImprimirCostoDeCompraEntreFechas vRpt = new dsrImprimirCostoDeCompraEntreFechas();
            if (vRpt.ConfigReport(Data, vParams)) {
                LibReport.SendReportToDevice(vRpt, 1, PrintingDevice, clsImprimirCostoDeCompraEntreFechas.ReportName, true, ExportFileFormat, "", false);
            }
