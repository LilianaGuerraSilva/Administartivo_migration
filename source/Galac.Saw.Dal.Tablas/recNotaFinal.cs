...
namespace Galac.Saw.Dal.Tablas {
    ...
    public class recNotaFinal {
        ...
        public recNotaFinal Clone() {
            recNotaFinal vResult = new recNotaFinal();
        ...
        public override string ToString() {
           return "Consecutivo Compania = " + _ConsecutivoCompania.ToString() +
               "\nCodigo De La Nota = " + _CodigoDeLaNota +
        ...
        public void Fill(XmlDocument refResulset, bool valSetCurrent) {
            ...
            if (valSetCurrent && insParser.Count() > 0) {
                ...
                CodigoDeLaNota = insParser.GetString(0, "CodigoDeLaNota", CodigoDeLaNota);
