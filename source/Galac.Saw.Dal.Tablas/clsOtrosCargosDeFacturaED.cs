...
namespace Galac.Saw.Dal.Tablas {
    ...
    public class clsOtrosCargosDeFacturaED: LibED, ILibMefDalComponent {
        ...
        private string SqlCreateTable() {
            ...
            SQL.AppendLine("Monto" + InsSql.DecimalTypeForDb(25, 4) + " CONSTRAINT d_otrCarDeFacMo DEFAULT (0), ");
            SQL.AppendLine("BaseFormula" + InsSql.CharTypeForDb(1) + " CONSTRAINT d_otrCarDeFacBaFo DEFAULT ('0'), ");
            SQL.AppendLine("PorcentajeSobreBase" + InsSql.DecimalTypeForDb(25, 4) + " CONSTRAINT d_otrCarDeFacPoSoBa DEFAULT (0), ");
            SQL.AppendLine("Sustraendo" + InsSql.DecimalTypeForDb(25, 4) + " CONSTRAINT d_otrCarDeFacSu DEFAULT (0), ");
            ...
            SQL.AppendLine("PorcentajeComision" + InsSql.DecimalTypeForDb(25, 4) + " CONSTRAINT d_otrCarDeFacPoCo DEFAULT (0), ");
        ...
        private string SqlSpInsParameters() {
            ...
            SQL.AppendLine("@PorcentajeSobreBase" + InsSql.DecimalTypeForDb(25, 4) + " = 0,");
        ...
        private string SqlSpUpdParameters() {
            ...
            SQL.AppendLine("@PorcentajeSobreBase" + InsSql.DecimalTypeForDb(25, 4) + ",");
