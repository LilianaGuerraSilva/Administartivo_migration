...
namespace Galac.Saw.Dal.Tablas {
    [Serializable]
    public class recPropAnalisisVenc {
        #region Variables
        ...
        public recPropAnalisisVenc Clone() {
            recPropAnalisisVenc vResult = new recPropAnalisisVenc();
        ...
        public void Fill(XmlDocument refResulset, bool valSetCurrent) {
            ...
            if (valSetCurrent && insParser.Count() > 0) {
                Clear();
                SecuencialUnique0 = insParser.GetInt(0, "SecuencialUnique0", SecuencialUnique0);
                PrimerVencimiento = insParser.GetInt(0, "PrimerVencimiento", PrimerVencimiento);
                SegundoVencimiento = insParser.GetInt(0, "SegundoVencimiento", SegundoVencimiento);
                TercerVencimiento = insParser.GetInt(0, "TercerVencimiento", TercerVencimiento);
    ...
    } //End of class recPropAnalisisVenc
