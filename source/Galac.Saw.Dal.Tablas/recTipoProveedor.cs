...
namespace Galac.Saw.Dal.Tablas {
    ...
    public class recTipoProveedor {
        ...
        public recTipoProveedor Clone() {
            recTipoProveedor vResult = new recTipoProveedor();
