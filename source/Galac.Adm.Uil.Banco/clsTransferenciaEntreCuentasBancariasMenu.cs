            ...
            if (vViewModel.DialogResult) {
                XElement vXmlResult = new XElement("Datos",
                    new XElement("Documento",
                        ...
                        , new XElement("GeneraImpuestoBancarioEgreso", LibConvert.ToStr(vViewModel.GeneraImpuestoBancarioEgreso))
                        ...
                        , new XElement("GeneraImpuestoBancarioIngreso", LibConvert.ToStr(vViewModel.GeneraImpuestoBancarioIngreso))
