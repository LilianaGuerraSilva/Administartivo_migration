...
namespace Galac.Adm.Uil.Banco {
    [LibMefUilComponentMetadata(typeof(UIMefBancoBeneficiario), "Bancos")]
    public class UIMefBancoBeneficiario : ILibMefUilComponent {
        #region Variables
        private BeneficiarioMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new BeneficiarioMngViewModel();
            }
        }
    ...
    } //End of class UIMefBancoBeneficiario
