...
namespace Galac.Adm.Brl.ImprentaDigital {
    public class ImprentaTheFactory: clsImprentaDigitalBase {
        ...
        private XElement GetTotalImpuestos(bool valParaMe) {
            decimal vCambioBs = (valParaMe ? FacturaImprentaDigital.CambioMostrarTotalEnDivisas : 1);
                    ...
                    foreach (FacturaRapidaDetalle vDetalle in DetalleFacturaImprentaDigital) {
                        ...
                        vResult.Add(
                            new XElement("detallesItems",
                                ...
                                new XElement("precioUnitarioDescuento", LibMath.RoundToNDecimals(vDetalle.PrecioSinIVA - LibMath.RoundToNDecimals((vDetalle.PrecioSinIVA * vDetalle.PorcentajeDescuento) / 100, 2), 2)),
