    ...
    public class ShellViewModel:LibShellViewModelBase {
        ...
        protected override XElement AddEspecialGlobalValues(XElement valGlobalValuesElement) {
            ...
            new XElement("FacturaRapida",
                ...
                new XElement("CuentaBancariaCobroDirecto", "04"),
            ...
            new XElement("Parametros",
                ...
                new XElement("CuentaBancariaCobroMultimoneda","00001"),
                ...
                new XElement("NombreCampoDefinibleInventario1", "PA"),
                new XElement("NombreCampoDefinibleInventario2", "PP"),
                new XElement("NombreCampoDefinibleInventario3", "PB"),
                new XElement("NombreCampoDefinibleInventario4", "PC"),
                new XElement("NombreCampoDefinibleInventario5", "PW"),
