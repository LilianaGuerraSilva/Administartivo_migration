...
namespace Galac.Adm.Brl.Venta {
    public partial class clsCobroDeFacturaRapidaDepositoTransfDetalleNav: LibBaseNavDetail<IList<CobroDeFacturaRapidaDepositoTransfDetalle>, IList<CobroDeFacturaRapidaDepositoTransfDetalle>> {
        #region Variables
        #endregion //Variables
        #region Propiedades
        ...
        public clsCobroDeFacturaRapidaDepositoTransfDetalleNav() {
        }
        #endregion //Constructores
        #region Metodos Generados

        protected override ILibDataDetailComponent<IList<CobroDeFacturaRapidaDepositoTransfDetalle>, IList<CobroDeFacturaRapidaDepositoTransfDetalle>> GetDataInstance() {
            return new Galac.Adm.Dal.Venta.clsCobroDeFacturaRapidaDepositoTransfDetalleDat();
        }
    ...
    } //End of class clsCobroDeFacturaRapidaDepositoTransfDetalleNav
