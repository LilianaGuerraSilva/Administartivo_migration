...
namespace Galac.Adm.Brl.Venta.Reportes {
    ...
    public class clsNotaDeEntregaRpt: ILibReportInfo, INotaDeEntregaInformes {
        ...
        DataTable INotaDeEntregaInformes.BuildNotaDeEntregaEntreFechasPorCliente(int valConsecutivoCompania, DateTime valtFechaDesde, DateTime valFechaHasta, bool valIncluirNotasDeEntregasAnuladas, Saw.Lib.eCantidadAImprimir valCantidadAImprimir, Saw.Lib.eMonedaParaImpresion valMonedaDelReporte, string valCodigoCliente) {
            ...
            vSql = insNotaDeEntregaSql.SqlNotaDeEntregaEntreFechasPorCliente(valConsecutivoCompania, valtFechaDesde, valFechaHasta, valIncluirNotasDeEntregasAnuladas, valCantidadAImprimir, valMonedaDelReporte, valCodigoCliente);
