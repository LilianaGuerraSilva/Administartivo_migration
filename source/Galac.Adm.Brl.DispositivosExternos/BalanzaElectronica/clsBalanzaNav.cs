...
namespace Galac.Adm.Brl.DispositivosExternos.BalanzaElectronica {
    public partial class clsBalanzaNav : LibBaseNav<IList<Balanza>, IList<Balanza>>, IBalanzaPdn {
        ...
        public clsBalanza CreateBalanza(Balanza ModelBalanza) {
            XElement vBalanzaDat = null;
            vBalanzaDat = FindByModeloBalanza(ModelBalanza);
            return clsBalanzaCreator.Create(vBalanzaDat);
        }
        ...
        private XElement FindByModeloBalanza(Balanza ModelBalanza) {
            XElement vResult = new XElement("GpData",
            new XElement("GpResult",
                new XElement("ConsecutivoCompania", ModelBalanza.ConsecutivoCompania),
                new XElement("Consecutivo", ModelBalanza.Consecutivo),
                new XElement("Modelo", ModelBalanza.ModeloAsDB),
                new XElement("Nombre", ModelBalanza.Nombre),
                new XElement("Puerto", ModelBalanza.PuertoAsDB),
                new XElement("BitsDatos", ModelBalanza.BitsDeDatosAsDB),
                new XElement("Paridad", ModelBalanza.ParidadAsDB),
                new XElement("BitDeParada", ModelBalanza.BitDeParadaAsDB),
                new XElement("BaudRate", ModelBalanza.BaudRateAsDB),
                new XElement("ControlDeFlujo", ModelBalanza.ControlDeFlujoAsDB)));
            return vResult;
        }
