...
namespace Galac.Saw.Uil.Integracion {
    [LibMefUilComponentMetadata(typeof(UIMefIntegracionIntegracion), "Saw")]
    public class UIMefIntegracionIntegracion : ILibMefUilComponent {
        #region Variables
        private IntegracionMngViewModel _ViewModel;
        ...
        public UIMefIntegracionIntegracion() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new IntegracionMngViewModel();
            }
        }
    ...
    } //End of class UIMefIntegracionIntegracion
