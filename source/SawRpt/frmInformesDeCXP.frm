...
Private Function fNombreDelArchivo(ByVal valLibro As String) As String
   ...
   NombreArchivo = gDefgen.fDataPathUser(gDefProg.GetSiglasDelPrograma, False) & "ArchivosXls\" & gUtilFile.fCreaElNombreDeArchivoDeExportacion(gProyCompaniaActual.GetNombre, True, varNombreArchivoXLS, ".xls")
