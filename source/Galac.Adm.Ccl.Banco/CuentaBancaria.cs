...
namespace Galac.Adm.Ccl.Banco {
	...
	public class CuentaBancaria {
		...
		public eTipoAlicPorContIGTF TipoDeAlicuotaPorContribuyenteAsEnum {
			get { return _TipoDeAlicuotaPorContribuyente; }
			set { _TipoDeAlicuotaPorContribuyente = value; }
		}

		public string TipoDeAlicuotaPorContribuyente {
			set { _TipoDeAlicuotaPorContribuyente = (eTipoAlicPorContIGTF) LibConvert.DbValueToEnum(value); }
		}

		public string TipoDeAlicuotaPorContribuyenteAsDB {
			get { return LibConvert.EnumToDbValue((int) _TipoDeAlicuotaPorContribuyente); }
		}

		public string TipoDeAlicuotaPorContribuyenteAsString {
