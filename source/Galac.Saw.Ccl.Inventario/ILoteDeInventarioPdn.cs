...
namespace Galac.Saw.Ccl.Inventario {
    public interface ILoteDeInventarioPdn : ILibPdn {
        ...
        void RecalcularMovimientosDeLoteDeInventario(int valConsecutivoCompania, eCantidadAImprimir valCantidadArticulos, string valCodigoArticulo, eCantidadAImprimir valCantidadLineas, string valLineaDeProducto);
