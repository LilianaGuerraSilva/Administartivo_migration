...
namespace Galac.Saw.Uil.Vehiculo {
    [LibMefUilComponentMetadata(typeof(UIMefVehiculoModelo), "Vehículo")]
    public class UIMefVehiculoModelo : ILibMefUilComponent {
        #region Variables
        private ModeloMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new ModeloMngViewModel();
            }
        }
    ...
    } //End of class UIMefVehiculoModelo
