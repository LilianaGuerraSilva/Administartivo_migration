...
namespace Galac.Saw.Uil.Vehiculo {
    [LibMefUilComponentMetadata(typeof(UIMefVehiculoVehiculo), "Vehículo")]
    public class UIMefVehiculoVehiculo : ILibMefUilComponent {
        #region Variables
        private VehiculoMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new VehiculoMngViewModel();
            }
        }
    ...
    } //End of class UIMefVehiculoVehiculo
