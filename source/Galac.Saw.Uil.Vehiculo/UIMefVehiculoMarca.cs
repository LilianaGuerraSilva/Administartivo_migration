...
namespace Galac.Saw.Uil.Vehiculo {
    [LibMefUilComponentMetadata(typeof(UIMefVehiculoMarca), "Vehículo")]
    public class UIMefVehiculoMarca : ILibMefUilComponent {
        #region Variables
        private MarcaMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new MarcaMngViewModel();
            }
        }
    ...
    } //End of class UIMefVehiculoMarca
