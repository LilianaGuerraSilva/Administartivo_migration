...
namespace Galac.Saw.Uil.Vehiculo {
    public class Modelo: LibMRO {
        ...
        public Modelo(string initNombre) {
        ...
        XmlReader ParseToXml(Modelo valEntidad) {
            List<Modelo> vListEntidades = new List<Modelo>();
        ...
        public void FindAndSetObject(string valNombre) {
            ...
            XmlReader vXmlDoc = _Reglas.GetData(eProcessMessageType.SpName, "ModeloGET", vParams.Get());
            Parse(vXmlDoc);
        }
        ...
        public bool ValidateAll(eAccionSR valAction, out string outErrorMessage) {
            ...
            vResult = IsValidMarca(valAction, Marca, false) && vResult;
