...
namespace Galac.Adm.Uil.GestionCompras.ViewModel {
    [LibMefInstallValuesMetadata(typeof(LibroDeComprasMngViewModel))]
    public class LibroDeComprasMngViewModel : LibGenericMngViewModel {
              
        #region Propiedades

        public override string ModuleName {
            get { return "Registro De Compras"; }
        }
        #endregion //Propiedades
        #region Constructores

        public LibroDeComprasMngViewModel()
            : base() {
            Title = ModuleName;
            try {
        ...
        */
        ...
        internal void ExecuteShowCommand() {
            try {
                LibroDeComprasViewModel insLibroDeCompras = new LibroDeComprasViewModel();
                LibMessages.EditViewModel.ShowEditor(insLibroDeCompras, true);
            } catch (Exception vEx) {
                LibMessages.MessageBox.Alert(this, vEx.Message, "");
            }
        }
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(LibroDeCompras valModel, eAccionSR valAction) {
    ...
    } //End of class LibroDeComprasMngViewModel
