...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasOrdenDeCompra), "Adm")]
    public class UIMefGestionComprasOrdenDeCompra : ILibMefUilComponent {
        #region Variables
        ...
        public string Name {
            get { return "Orden De Compra Nacional"; }
        }
        ...
        public UIMefGestionComprasOrdenDeCompra() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new OrdenDeCompraMngViewModel(Ccl.GestionCompras.eTipoCompra.Nacional);
                }
