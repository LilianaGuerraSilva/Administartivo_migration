...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasImportacion), "Adm")]
    public class UIMefGestionComprasImportacion : ILibMefUilComponent {
        #region Variables
        private CompraMngViewModel _ViewModel;
        private ContentControl _View;
        #endregion //Variables
        #region Propiedades

        public string Name {
            get { return "Importación"; }
        }
        ...
        public UIMefGestionComprasImportacion() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CompraMngViewModel(Ccl.GestionCompras.eTipoCompra.Importacion );
                }
    ...
    } //End of class UIMefGestionComprasCompra
