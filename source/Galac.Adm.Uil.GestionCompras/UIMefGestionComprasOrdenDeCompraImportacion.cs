...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasOrdenDeCompraImportacion), "Adm")]
    public class UIMefGestionComprasOrdenDeCompraImportacion : ILibMefUilComponent {
        #region Variables
        private OrdenDeCompraMngViewModel _ViewModel;
        private ContentControl _View;
        #endregion //Variables
        #region Propiedades

        public string Name {
            get { return "Orden De Compra Importacion"; }
        }
        ...
        public UIMefGestionComprasOrdenDeCompraImportacion() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new OrdenDeCompraMngViewModel(Ccl.GestionCompras.eTipoCompra.Importacion);
                }
    ...
    } //End of class UIMefGestionComprasOrdenDeCompra
