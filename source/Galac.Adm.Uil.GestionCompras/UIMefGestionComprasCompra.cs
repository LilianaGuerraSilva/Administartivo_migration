...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasCompra), "Adm")]
    public class UIMefGestionComprasCompra : ILibMefUilComponent {
        #region Variables
        ...
        public UIMefGestionComprasCompra() {
        }
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CompraMngViewModel(Ccl.GestionCompras.eTipoCompra.Nacional );
                }
