...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasProveedor), "Adm")]
    public class UIMefGestionComprasProveedor : ILibMefUilComponent {
        #region Variables
        private ProveedorMngViewModel _ViewModel;
        ...
        public UIMefGestionComprasProveedor() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new ProveedorMngViewModel();
                }
    ...
    } //End of class UIMefGestionComprasProveedor
