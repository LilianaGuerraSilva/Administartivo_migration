...
namespace Galac.Adm.Uil.GestionCompras {
    [LibMefUilComponentMetadata(typeof(UIMefGestionComprasCargaInicial), "Adm")]
    public class UIMefGestionComprasCargaInicial : ILibMefUilComponent {
        #region Variables
        private CargaInicialMngViewModel _ViewModel;
        ...
        public UIMefGestionComprasCargaInicial() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new CargaInicialMngViewModel();
                }
    ...
    } //End of class UIMefGestionComprasCargaInicial
