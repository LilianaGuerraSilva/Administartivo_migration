...
namespace Galac.Saw.Uil.Cliente {
    [LibMefUilComponentMetadata(typeof(UIMefClienteCliente), "Saw")]
    public class UIMefClienteCliente : ILibMefUilComponent {
        #region Variables
        private ClienteMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new ClienteMngViewModel();
                }
    ...
    } //End of class UIMefClienteCliente
