...
namespace Galac.Saw.Uil.Inventario {
    [LibMefUilComponentMetadata(typeof(UIMefInventarioTalla), "Inventario")]
    public class UIMefInventarioTalla : ILibMefUilComponent {
        #region Variables
        private TallaMngViewModel _ViewModel;
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new TallaMngViewModel();
            }
        }
    ...
    } //End of class UIMefInventarioTalla
