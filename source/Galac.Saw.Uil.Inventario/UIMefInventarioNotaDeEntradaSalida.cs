...
namespace Galac.Saw.Uil.Inventario {
    [LibMefUilComponentMetadata(typeof(UIMefInventarioNotaDeEntradaSalida), "Saw")]
    public class UIMefInventarioNotaDeEntradaSalida : ILibMefUilComponent {
        #region Variables
        private NotaDeEntradaSalidaMngViewModel _ViewModel;
        ...
        public UIMefInventarioNotaDeEntradaSalida() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new NotaDeEntradaSalidaMngViewModel();
                }
    ...
    } //End of class UIMefInventarioNotaDeEntradaSalida
