    ...
    public class clsMovimientoDeLoteInventarioViewModel : LibInputRptViewModelBase<LoteDeInventario> {
        ...
        private void ExecuteChooseCodigoArticuloCommand(string valCodigo) {
            try {
                ...
                vDefaultCriteria2.Add(LibSearchCriteria.CreateCriteria("Gv_ArtiuloInventario_B1.TipoArticuloInv", eTipoArticuloInv.LoteFechadeVencimiento), eLogicOperatorType.Or);
