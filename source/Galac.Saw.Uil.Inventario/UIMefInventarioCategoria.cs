...
namespace Galac.Saw.Uil.Inventario {
    [LibMefUilComponentMetadata(typeof(UIMefInventarioCategoria), "Inventario")]
    public class UIMefInventarioCategoria : ILibMefUilComponent {
        #region Variables
        private CategoriaMngViewModel _ViewModel;
        ...
        public UIMefInventarioCategoria() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            if(!IsInitialized) {
                IsInitialized = true;
                _ViewModel = new CategoriaMngViewModel();
            }
        }
    ...
    } //End of class UIMefInventarioCategoria
