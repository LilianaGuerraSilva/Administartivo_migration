...
namespace Galac.Saw.Uil.Inventario.ViewModel {
    public class LoteDeInventarioViewModel : LibInputMasterViewModelMfc<LoteDeInventario> {
        ...
        public bool IsVisibleFechaDeElaboracionLoteDeInventario {
            get { return TipoArticuloInv == eTipoArticuloInv.LoteFechadeVencimiento || TipoArticuloInv == eTipoArticuloInv.LoteFechadeElaboracion; }
        }
        ...
        private ValidationResult FechaDeElaboracionValidating() {
            ...
            if ((Action == eAccionSR.Consultar) || (Action == eAccionSR.Eliminar)) {
                ...
                if (TipoArticuloInv == eTipoArticuloInv.Lote) {
                    FechaDeElaboracion = LibDate.MaxDateForDB();
                } else if (TipoArticuloInv == eTipoArticuloInv.LoteFechadeVencimiento || TipoArticuloInv == eTipoArticuloInv.LoteFechadeElaboracion) {
        ...
        private ValidationResult FechaDeVencimientoValidating() {
            ...
            if ((Action == eAccionSR.Consultar) || (Action == eAccionSR.Eliminar)) {
                ...
                if (TipoArticuloInv == eTipoArticuloInv.Lote || TipoArticuloInv == eTipoArticuloInv.LoteFechadeElaboracion) {
