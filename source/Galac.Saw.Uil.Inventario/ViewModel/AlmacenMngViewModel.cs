...
namespace Galac.Saw.Uil.Inventario.ViewModel {
    ...
    public class AlmacenMngViewModel : LibMngViewModelMfc<AlmacenViewModel, Almacen> {
        #region Propiedades
        ...
        */
        ...
        protected override AlmacenViewModel CreateNewElement(Almacen valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new Almacen();
            }
            return new AlmacenViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_Almacen_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
		...
		*/
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(Almacen valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class AlmacenMngViewModel
