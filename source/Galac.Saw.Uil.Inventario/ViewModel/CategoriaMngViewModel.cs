...
namespace Galac.Saw.Uil.Inventario.ViewModel {
    ...
    public class CategoriaMngViewModel : LibMngViewModelMfc<CategoriaViewModel, Categoria> {
        #region Propiedades
        ...
        */
        ...
        protected override CategoriaViewModel CreateNewElement(Categoria valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new Categoria();
            }
            return new CategoriaViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_Categoria_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(Categoria valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class CategoriaMngViewModel
