...
namespace Galac.Saw.Uil.Inventario.ViewModel {
    ...
    public class ColorMngViewModel : LibMngViewModelMfc<ColorViewModel, Color> {
        #region Propiedades
        ...
        */
        ...
        public ColorMngViewModel()
            : base(LibGlobalValues.Instance.GetAppMemInfo(), LibGlobalValues.Instance.GetMfcInfo()) {
            Title = "Buscar " + ModuleName;
            OrderByMember = "ConsecutivoCompania, CodigoColor";
        #region Codigo Ejemplo
        /* Codigo de Ejemplo
        ...
        */
        ...
        protected override ColorViewModel CreateNewElement(Color valModel, eAccionSR valAction) {
            var vNewModel = valModel;
            if (vNewModel == null) {
                vNewModel = new Color();
            }
            return new ColorViewModel(vNewModel, valAction);
        }

        protected override LibSearchCriteria GetMFCCriteria() {
            return LibSearchCriteria.CreateCriteria("Gv_Color_B1.ConsecutivoCompania", Mfc.GetInt("Compania"));
        }
        ...
        protected override ILibReportInfo GetDataRetrievesInstance() {
            return new clsColorRpt(ModuleName);
        }
        ...
        */
        ...
        ANYRELATEDViewModel CreateNewElementForSUPROCESOPARTICULAR(Color valModel, eAccionSR valAction) {
            var vNewModel = valModel;
    ...
    } //End of class ColorMngViewModel
