...
namespace Galac.Saw.Uil.Inventario {
    [LibMefUilComponentMetadata(typeof(UIMefInventarioLoteDeInventario), "Saw")]
    public class UIMefInventarioLoteDeInventario : ILibMefUilComponent {
        #region Variables
        private LoteDeInventarioMngViewModel _ViewModel;
        ...
        public UIMefInventarioLoteDeInventario() {
        ...
        */
        ...
        public void InitializeIfNecessary() {
            try {
                if (!IsInitialized) {
                    IsInitialized = true;
                    _ViewModel = new LoteDeInventarioMngViewModel();
                }
    ...
    } //End of class UIMefInventarioLoteDeInventario
