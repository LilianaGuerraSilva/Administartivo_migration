...
namespace Galac.Adm.Dal.CajaChica {
    public class clsAnticipoED: LibED {
        #region Variables
        #endregion //Variables
        #region Propiedades
        ...
        private string SqlCreateTable() {
            ...
            SQL.AppendLine("CodigoBeneficiario" + InsSql.VarCharTypeForDb(10) + " CONSTRAINT nnAntCodigoBene NOT NULL, ");
            ...
            SQL.AppendLine("Moneda" + InsSql.VarCharTypeForDb(80) + " CONSTRAINT nnAntMoneda NOT NULL, ");
            ...
            SQL.AppendLine(", CONSTRAINT fk_AnticipoBeneficiario FOREIGN KEY (ConsecutivoCompania, CodigoBeneficiario)");
            SQL.AppendLine("REFERENCES Saw.Beneficiario(ConsecutivoCompania, codigo)");
        ...
        private string SqlViewB1() {
            StringBuilder SQL = new StringBuilder();
            SQL.AppendLine("SELECT Anticipo.ConsecutivoCompania, Anticipo.ConsecutivoAnticipo, Anticipo.Status, " + DbSchema + ".Gv_EnumStatusAnticipo.StrValue AS StatusStr, Anticipo.Tipo");
            SQL.AppendLine(", Anticipo.Fecha, Anticipo.Numero, Anticipo.CodigoBeneficiario, Anticipo.CodigoCliente");
            SQL.AppendLine(", Anticipo.CodigoProveedor, Anticipo.Moneda, Anticipo.Cambio, Anticipo.GeneraMovBancario");
            SQL.AppendLine(", Anticipo.CodigoCuentaBancaria, Anticipo.CodigoConceptoBancario, Anticipo.GeneraImpuestoBancario, Anticipo.FechaAnulacion");
            SQL.AppendLine(", Anticipo.FechaCancelacion, Anticipo.FechaDevolucion, Anticipo.Descripcion, Anticipo.MontoTotal");
            SQL.AppendLine(", Anticipo.MontoUsado, Anticipo.MontoDevuelto, Anticipo.MontoDiferenciaEnDevolucion, Anticipo.DiferenciaEsIDB");
            SQL.AppendLine(", Anticipo.EsUnaDevolucion, Anticipo.NumeroDelAnticipoDevuelto, Anticipo.NumeroCheque, Anticipo.AsociarAnticipoACotiz");
            SQL.AppendLine(", Anticipo.NumeroCotizacion, Anticipo.ConsecutivoRendicion, Anticipo.NombreOperador, Anticipo.FechaUltimaModificacion");
            //SQL.AppendLine(", dbo.Cliente.nombre AS NombreCliente");
            //SQL.AppendLine(", dbo.Proveedor.nombreProveedor AS NombreProveedor");
            ...
            //SQL.AppendLine("INNER JOIN Saw.Beneficiario ON  " + DbSchema + ".Anticipo.CodigoBeneficiario = Saw.Beneficiario.codigo");
            //SQL.AppendLine("      AND " + DbSchema + ".Anticipo.ConsecutivoCompania = Saw.Beneficiario.ConsecutivoCompania");
            //SQL.AppendLine("INNER JOIN dbo.Cliente ON  " + DbSchema + ".Anticipo.CodigoCliente = dbo.Cliente.codigo");
            //SQL.AppendLine("      AND " + DbSchema + ".Anticipo.ConsecutivoCompania = dbo.Cliente.ConsecutivoCompania");
            //SQL.AppendLine("INNER JOIN dbo.Proveedor ON  " + DbSchema + ".Anticipo.CodigoProveedor = dbo.Proveedor.codigoProveedor");
            //SQL.AppendLine("      AND " + DbSchema + ".Anticipo.ConsecutivoCompania = dbo.Proveedor.ConsecutivoCompania");
            ...
            //SQL.AppendLine("INNER JOIN dbo.Cotizacion ON  " + DbSchema + ".Anticipo.NumeroCotizacion = dbo.Cotizacion.Numero");
            //SQL.AppendLine("      AND " + DbSchema + ".Anticipo.ConsecutivoCompania = dbo.Cotizacion.ConsecutivoCompania");
            //SQL.AppendLine("INNER JOIN Adm.Rendicion ON  " + DbSchema + ".Anticipo.ConsecutivoRendicion = Adm.Rendicion.Consecutivo");
        ...
        private string SqlSpSearch() {
            ...
            SQL.AppendLine("      " + DbSchema + ".Gv_Anticipo_B1.CodigoBeneficiario,");
            ...
            //SQL.AppendLine("      " + DbSchema + ".Proveedor.nombreProveedor AS NombreProveedor,");
            ...
            //SQL.AppendLine("      INNER JOIN Saw.Gv_Beneficiario_B1 ON  " + DbSchema + ".Gv_Anticipo_B1.CodigoBeneficiario = Saw.Gv_Beneficiario_B1.codigo");
            //SQL.AppendLine("      AND " + DbSchema + ".Gv_Anticipo_B1.ConsecutivoCompania = Saw.Gv_Beneficiario_B1.ConsecutivoCompania");
            //SQL.AppendLine("      INNER JOIN dbo.Cliente ON  " + DbSchema + ".Gv_Anticipo_B1.CodigoCliente = dbo.Cliente.codigo");
            //SQL.AppendLine("      AND " + DbSchema + ".Gv_Anticipo_B1.ConsecutivoCompania = dbo.Cliente.ConsecutivoCompania");
            //SQL.AppendLine("      INNER JOIN dbo.Proveedor ON  " + DbSchema + ".Gv_Anticipo_B1.CodigoProveedor = dbo.Proveedor.codigoProveedor");
            //SQL.AppendLine("      AND " + DbSchema + ".Gv_Anticipo_B1.ConsecutivoCompania = dbo.Proveedor.ConsecutivoCompania");
            SQL.AppendLine("      INNER JOIN dbo.Moneda ON  " + DbSchema + ".Gv_Anticipo_B1.Moneda = dbo.Moneda.Nombre");
            ...
            SQL.AppendLine("      INNER JOIN Adm.ConceptoBancario ON  " + DbSchema + ".Gv_Anticipo_B1.CodigoConceptoBancario = Adm.ConceptoBancario.codigo");
            //SQL.AppendLine("      INNER JOIN dbo.Cotizacion ON  " + DbSchema + ".Gv_Anticipo_B1.NumeroCotizacion = dbo.Cotizacion.Numero");
            //SQL.AppendLine("      AND " + DbSchema + ".Gv_Anticipo_B1.ConsecutivoCompania = dbo.Cotizacion.ConsecutivoCompania");
            //SQL.AppendLine("      INNER JOIN Adm.Gv_Rendicion_B1 ON  " + DbSchema + ".Gv_Anticipo_B1.ConsecutivoRendicion = Adm.Gv_Rendicion_B1.Consecutivo");
        ...
        private string SqlSpGetFK() {
            ...
            SQL.AppendLine("      " + DbSchema + ".Anticipo.CodigoBeneficiario,");
...
} //End of namespace Galac.Adm.Dal.CajaChica
