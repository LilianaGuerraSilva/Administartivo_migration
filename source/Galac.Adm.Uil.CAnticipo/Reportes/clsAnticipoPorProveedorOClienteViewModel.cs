...
namespace Galac.Adm.Uil.CAnticipo.Reportes {
    ...
    public class clsAnticipoPorProveedorOClienteViewModel : LibInputRptViewModelBase<Anticipo> {
        ...
        private eClientesOrdenadosPor _ClientesOrdenadosPor;
        #endregion //Variables

        #region Propiedades
        public override string DisplayName {
            get {
                return NombreDelInformeSegunSujeto();
            }
        }

        private string NombreDelInformeSegunSujeto() {
            if (EsCliente) {
                return "Anticipos Cobrados a Cliente";
            } else {
                return "Anticipos Pagados a Proveedor";
            }
        }
        ...
        public eCantidadAImprimir CantidadAImprimirClienteProveedor {
         ...
         [LibCustomValidation("CodigoClienteProveedorlValidating")]
        ...
        public ObservableCollection<string> ListaOrdenarPor { get; set; }
        public string OrdenadoPor { get; set; }

        public bool OrdenamientoPorStatus {
            get {
                return LibString.S1IsEqualToS2(OrdenadoPor, ListaOrdenarPor[0]);
            }            
        }
        ...
        private void LlenarListaEstatus() {
            ListaOrdenarPor = new ObservableCollection<string> { "Estatus", EsCliente ? "Cliente" : "Proveedor" };
            OrdenadoPor = ListaOrdenarPor[0];
        }

        protected override string ValidateProperty(string valColumnName) {
            return base.ValidateProperty(valColumnName);
        }
