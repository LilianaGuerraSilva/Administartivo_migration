...
namespace Galac.Adm.Ccl.Venta {
    ...
    public interface ICajaInformes {
        ...
        System.Data.DataTable BuildCajaCerrada(int valConsecutivoCompania, int valConsecutivoCaja, DateTime valFechaDesde, DateTime valFechaHasta, ref decimal refEfectivoEnCaja, ref decimal refEfectivoEnCajaMe);
    }
