...
namespace Galac.Adm.Ccl.Venta {
    ...
    public interface INotaDeEntregaInformes {
        System.Data.DataTable BuildNotaDeEntregaEntreFechasPorCliente(int valConsecutivoCompania, 
                                                                      DateTime valtFechaDesde,
                                                                      DateTime valFechaHasta,
                                                                      bool valIncluirNotasDeEntregasAnuladas,
                                                                      eCantidadAImprimir valCantidadAImprimir,
                                                                      eMonedaParaImpresion valMonedaDelReporte,
