    ...
    public class clsReestructurarDatabase : QAdvReest, ILibRestructureDb, ILibRestructureToVersion {
        ...
        public bool UpgradeToNewVersion(string valCurrentVersionInDb, string valDestinyVersion) {
            ...
            try {
                ...
                if (HasToUpgradeToVersion("6.60")) {
                    vResult = vResult && new clsVersion6_60(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.61")) {
                    vResult = vResult && new clsVersion6_61(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.63")) {
                    vResult = vResult && new clsVersion6_63(_CurrentDataBaseName).UpdateToVersion();
                }
                ...
                if (HasToUpgradeToVersion("6.66")) {
                    vResult = vResult && new clsVersion6_66(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.67")) {
                    vResult = vResult && new clsVersion6_67(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.68")) {
                    vResult = vResult && new clsVersion6_68(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.69")) {
                    vResult = vResult && new clsVersion6_69(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.70")) {
                    vResult = vResult && new clsVersion6_70(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.71")) {
                    vResult = vResult && new clsVersion6_71(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.73")) {
                    vResult = vResult && new clsVersion6_73(_CurrentDataBaseName).UpdateToVersion();
                }
                if (HasToUpgradeToVersion("6.75")) {
                    vResult = vResult && new clsVersion6_75(_CurrentDataBaseName).UpdateToVersion();
                }
                ...
                if (HasToUpgradeToVersion("6.79")) {
                    vResult = vResult && new clsVersion6_79(_CurrentDataBaseName).UpdateToVersion();
                }
                vResult = vResult && new clsVersionTemporalNoOficial(_CurrentDataBaseName).UpdateToVersion();
                //vResult = vResult && CreateLostFields();
                return vResult;
