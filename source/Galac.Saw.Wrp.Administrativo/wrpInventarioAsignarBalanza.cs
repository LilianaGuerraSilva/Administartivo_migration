...
namespace Galac.Saw.Wrp.Inventario {
    ...
    public class wrpInventarioAsignarBalanza: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Inventario Asignar Balanza";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenu insMenu = new Galac.Saw.Uil.Inventario.clsAsignarBalanzaMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Inventario.clsAsignarBalanzaMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
        ...
        private void CreateGlobalValues(string valCurrentParameters) {
            ...
            LibGlobalValues.Instance.GetMfcInfo().Add("Compania", LibGlobalValues.Instance.GetAppMemInfo().GlobalValuesGetInt("Inventario", "ConsecutivoCompania"));            
        }
        #endregion //Metodos Generados


    } //End of class wrpInventarioAsignarBalanza
