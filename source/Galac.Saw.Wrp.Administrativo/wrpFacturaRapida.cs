...
namespace Galac.Saw.Wrp.Venta {
    ...
    public class wrpFacturaRapida : System.EnterpriseServices.ServicedComponent, IWrpMfVb{
#region Variables
        string _Title = "Punto de Venta";
#endregion //Variables
#region Propiedades
...
#region Miembros de IWrpMfVb
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenu insMenu = new Galac.Adm.Uil.Venta.clsFacturaRapidaMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Adm.Uil.Venta.clsFacturaRapidaMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
        ...
        private void CreateGlobalValues(string valCurrentParameters) {
            ...
            LibGlobalValues.Instance.GetMfcInfo().Add("Compania", LibGlobalValues.Instance.GetAppMemInfo().GlobalValuesGetInt("FacturaRapida", "ConsecutivoCompania"));
            LibGlobalValues.Instance.GetMfcInfo().Add("Periodo", LibGlobalValues.Instance.GetAppMemInfo().GlobalValuesGetInt("FacturaRapida", "ConsecutivoPeriodo"));
        }
