...
namespace Galac.Saw.Wrp.Vehiculo {
    ...
    public class wrpMarca: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Marca";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Saw.Uil.Vehiculo.clsMarcaMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Vehiculo.clsMarcaMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
