...
namespace Galac.Saw.Wrp.MenuBar {
    ...
    public class wrpMenuBarLoteDeInventario : System.EnterpriseServices.ServicedComponent, IWrpMfMenuBarVb {
        #region Variables
        ...
        private XElement ComponentsNavigationTab() {
            ...
            vResult = new XElement("Components",
                         new XElement("UilComponents",
                             new XElement("UilComponent", new XAttribute("Name", "UIMefInventarioLoteDeInventario"), new XAttribute("Module", "Lote de Inventario"))));
            return vResult;
        }
