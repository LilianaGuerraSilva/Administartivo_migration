...
namespace Galac.Saw.Wrp.MenuBar {
    ...
    public class wrpMenuBarInventario : System.EnterpriseServices.ServicedComponent, IWrpMfMenuBarVb {
        #region Variables
        string _Title = "Inventario";
        #endregion //Variables
        ...
        void IWrpMfMenuBarVb.CallMain(string vfwCurrentParameters) {            
            try {
                ...
                LibGlobalValues.Instance.LoadMFCInfoFromAppMemInfo("Parametros", "ConsecutivoCompania");
        ...
        private XElement ComponentsNavigationTab() {
            XElement vResult = new XElement("Components",
                  new XElement("UilComponents",
                      new XElement("UilComponent", new XAttribute("Name", "UIMefInventarioVerificadorDePrecios"))
                      ));
            return vResult;
        }
