...
namespace Galac.Saw.Wrp.Tablas {
    ...
    public class wrpTipoProveedor: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Tipo Proveedor";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenuMultiFile insMenu = new Galac.Saw.Uil.Tablas.clsTipoProveedorMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Tablas.clsTipoProveedorMenu.ChooseTipoProveedorFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
