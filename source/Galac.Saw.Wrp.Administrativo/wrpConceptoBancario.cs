...
namespace Galac.Saw.Wrp.Banco {
    ...
    public class wrpConceptoBancario : System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Concepto Bancario";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Adm.Uil.Banco.clsConceptoBancarioMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Adm.Uil.Banco.clsConceptoBancarioMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpConceptoBancario
