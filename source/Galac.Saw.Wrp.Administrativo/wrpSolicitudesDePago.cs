...
namespace Galac.Saw.Wrp.Banco {
    ...
    public class wrpSolicitudesDePago: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Solicitudes De Pago";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
               ...
               //LibGlobalValues insGV = CreateGlobalValues(vfwCurrentParameters);
               //ILibMenuMultiFile insMenu = new Galac.Adm.Uil.Banco.clsSolicitudesDePagoMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Adm.Uil.Banco.clsSolicitudesDePagoMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
        ...
        private LibGlobalValues CreateGlobalValues(string valCurrentParameters) {
           ...
           LibGlobalValues.Instance.GetMfcInfo().Add("Compania", LibGlobalValues.Instance.GetAppMemInfo().GlobalValuesGetInt("SolicitudDePago", "ConsecutivoCompania"));
           LibGlobalValues.Instance.GetMfcInfo().Add("Periodo", LibGlobalValues.Instance.GetAppMemInfo().GlobalValuesGetInt("SolicitudDePago", "ConsecutivoPeriodo"));
           return LibGlobalValues.Instance;
        }
        #endregion //Metodos Generados


    } //End of class wrpSolicitudesDePago
