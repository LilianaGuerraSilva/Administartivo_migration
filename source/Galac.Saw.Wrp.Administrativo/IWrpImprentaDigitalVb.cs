...
namespace Galac.Saw.Wrp.ImprentaDigital {
    public interface IWrpImprentaDigitalVb {
        ...
        bool AnularDocumento(int vfwTipoDocumento, string vfwNumeroFactura, int vfwvTipoDocumentoImprentaDigital, string vfwCurrentParameters, ref string vMensaje);
        bool SincronizarDocumento(int vfwTipoDocumento, string vfwNumeroFactura, string vfwCurrentParameters, int vfwvTipoDocumentoImprentaDigital, ref string vfwNumeroControl, ref string vfwMensaje);       
