...
namespace Galac.Saw.Wrp.ImprentaDigital {
    public interface IWrpImprentaDigitalVb {
        ...
        bool AnularDocumento(int vfwTipoDocumento, string vfwNumeroFactura,  string vfwCurrentParameters, int vfwvTipoDocumentoImprentaDigital, ref string vMensaje);
