...
namespace Galac.Saw.Wrp.ImprentaDigital {
    public interface IWrpImprentaDigitalVb {
        bool EnviarDocumento(int vfwTipoDocumento, string vfwNumeroFactura, string vfwCurrentParameters, int vfwTipoComprobantedeRetencion, ref string vfwNumeroControl, ref string vfwMensaje);
        bool AnularDocumento(int vfwTipoDocumento, string vfwNumeroFactura, string vfwCurrentParameters, ref string vMensaje);
        bool SincronizarDocumento(int vfwTipoDocumento, string vfwNumeroFactura, string vfwCurrentParameters, int vfwTipoComprobantedeRetencion, ref string vfwNumeroControl, ref string vfwMensaje);       
