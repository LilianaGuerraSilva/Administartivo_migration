...
namespace Galac.Saw.Wrp.Banco {
   ...
   public class wrpBeneficiario : System.EnterpriseServices.ServicedComponent, IWrpMfVb {
#region Variables
      string _Title = "Beneficiario";
#endregion //Variables
#region Propiedades
...
#region Miembros de IWrpMfVb
      ...
      void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
         try {
            ...
            ILibMenuMultiFile insMenu = new Galac.Adm.Uil.Banco.clsBeneficiarioMenu();
      ...
      string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
         ...
         try {
            ...
            if (Galac.Adm.Uil.Banco.clsBeneficiarioMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
