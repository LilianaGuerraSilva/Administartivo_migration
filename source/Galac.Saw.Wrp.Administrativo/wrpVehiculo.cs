...
namespace Galac.Saw.Wrp.Vehiculo {
    ...
    public class wrpVehiculo: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
#region Variables
        string _Title = "Vehículo";
#endregion //Variables
#region Propiedades
...
#region Miembros de IWrpMfVb
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
           try {
              ...
              ILibMenu insMenu = new Galac.Saw.Uil.Vehiculo.clsVehiculoMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Vehiculo.clsVehiculoMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpVehiculo

} //End of namespace Galac.Saw.Wrp.Vehiculo
