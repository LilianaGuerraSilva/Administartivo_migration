...
namespace Galac.Saw.Wrp.Tablas {
    ...
    public class wrpNotaFinal: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Nota Final";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenuMultiFile insMenu = new Galac.Saw.Uil.Tablas.clsNotaFinalMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Tablas.clsNotaFinalMenu.ChooseNotaFinal(null, ref vXmlDocument, vSearchValues, vFixedValues)) {
