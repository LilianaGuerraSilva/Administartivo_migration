...
namespace Galac.Saw.Wrp.MenuBar {
    ...
    public class wrpMenuBarProduccion : System.EnterpriseServices.ServicedComponent, IWrpMfMenuBarVb {
        #region Variables
        ...
        private XElement ComponentsNavigationTab(bool valUsaCostoPromedio) {
            XElement vResult = new XElement("Components",
                  new XElement("UilComponents",
                      new XElement("UilComponent", new XAttribute("Name", "UIMefGestionProduccionListaDeMateriales"), new XAttribute("Module", "Producción")),
                      new XElement("UilComponent", new XAttribute("Name", "UIMefGestionProduccionOrdenDeProduccion"), new XAttribute("Module", "Producción"))
                        ));
            return vResult;
        }
        ...
        private List<string> ComponentsList() {
            ...
            vResult.Add("Galac.Adm.Uil.GestionProduccion");
            return vResult;
        }
