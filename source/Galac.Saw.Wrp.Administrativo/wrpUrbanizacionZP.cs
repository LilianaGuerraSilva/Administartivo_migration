...
namespace Galac.Saw.Wrp.Tablas {
    ...
    public class wrpUrbanizacionZP: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Urbanización - Zona Postal";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Saw.Uil.Tablas.clsUrbanizacionZPMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Tablas.clsPropAnalisisVencMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpUrbanizacionZP
