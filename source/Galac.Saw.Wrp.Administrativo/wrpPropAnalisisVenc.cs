...
namespace Galac.Saw.Wrp.Tablas {
    ...
    public class wrpPropAnalisisVenc: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Prop Analisis Venc";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Saw.Uil.Tablas.clsPropAnalisisVencMenu();
    ...
    } //End of class wrpPropAnalisisVenc
