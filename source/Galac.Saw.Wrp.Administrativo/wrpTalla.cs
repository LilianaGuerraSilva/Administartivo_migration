...
namespace Galac.Saw.Wrp.Inventario {
    ...
    public class wrpTalla: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
#region Variables
        string _Title = "Talla";
#endregion //Variables
#region Propiedades
...
#region Miembros de IWrpMfVb
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenuMultiFile insMenu = new Galac.Saw.Uil.Inventario.clsTallaMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Inventario.clsTallaMenu.ChooseTallaFromInterop( ref vXmlDocument, vSearchValues, vFixedValues)) {
