...
namespace Galac.Saw.Wrp.Inventario {
    ...
    public class wrpListaDeMateriales: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Lista de Materiales";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenu insMenu = new Galac.Adm.Uil.GestionProduccion.clsListaDeMaterialesMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Adm.Uil.GestionProduccion.clsListaDeMaterialesMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
    ...
    } //End of class wrpListaDeMateriales
