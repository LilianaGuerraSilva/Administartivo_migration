...
namespace Galac.Saw.Wrp.Tablas {
    ...
    public class wrpUnidadDeVenta: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Unidad De Venta";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Saw.Uil.Tablas.clsUnidadDeVentaMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Tablas.clsUnidadDeVentaMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
