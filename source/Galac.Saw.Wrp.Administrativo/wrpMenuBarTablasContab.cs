...
namespace Galac.Saw.Wrp.MenuBar {
    ...
    public class wrpMenuBarTablasContab: System.EnterpriseServices.ServicedComponent, IWrpMfMenuBarVb {
        #region Variables
        ...
        private XElement ComponentsNavigationTab() {
            XElement vResult = new XElement("Components",
                new XElement("UilComponents",
                    new XElement("UilComponent", new XAttribute("Name", "UIMefTablasTipoDeComprobante"), new XAttribute("Group", "Tablas de Contabilidad")),
                    new XElement("UilComponent", new XAttribute("Name", "UIMefWinContAuxiliar"), new XAttribute("Group", "Tablas de Contabilidad")),
                    new XElement("UilComponent", new XAttribute("Name", "UIMefWinContCentroDeCostos"), new XAttribute("Group", "Tablas de Contabilidad"))
                    ));
            return vResult;
        }
        ...
        private List<string> ComponentsList() {
            ...
            vResult.Add("Galac.Contab.Uil.Tablas");
            return vResult;
        }
    }
}
