...
namespace Galac.Saw.Wrp.Vendedor {
    ...
    public class wrpVendedor: System.EnterpriseServices.ServicedComponent, IWrpVendedorVb {
        ...
        string IWrpVendedorVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            string vResult = "";
            ...
            try {
                ...
                if (Galac.Adm.Uil.Vendedor.clsVendedorMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
...
} //End of namespace Galac.Saw.Wrp.Vendedor