...
namespace Galac.Saw.Wrp.Vehiculo {
    ...
    public class wrpModelo: System.EnterpriseServices.ServicedComponent, IWrpVb {
        #region Variables
        string _Title = "Modelo";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpVb.Execute(string vfwAction) {
            try {
                ILibMenu insMenu = new Galac.Saw.Uil.Vehiculo.clsModeloMenu();
        ...
        string IWrpVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Vehiculo.clsModeloMenu.ChooseFromInterop(ref vXmlDocument, vSearchValues, vFixedValues)) {
