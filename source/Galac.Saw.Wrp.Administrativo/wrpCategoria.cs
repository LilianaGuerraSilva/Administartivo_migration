...
namespace Galac.Saw.Wrp.Inventario {
    ...
    public class wrpCategoria: System.EnterpriseServices.ServicedComponent, IWrpMfVb {
        #region Variables
        string _Title = "Categoria";
        #endregion //Variables
        #region Propiedades
        ...
        void IWrpMfVb.Execute(string vfwAction, string vfwCurrentMfc, string vfwCurrentParameters) {
            try {
                ...
                ILibMenuMultiFile insMenu = new Galac.Saw.Uil.Inventario.clsCategoriaMenu();
        ...
        string IWrpMfVb.Choose(string vfwParamInitializationList, string vfwParamFixedList) {
            ...
            try {
                ...
                if (Galac.Saw.Uil.Inventario.clsCategoriaMenu.ChooseCategoriaFromInterop( ref vXmlDocument, vSearchValues, vFixedValues)) {
