...
namespace Galac.Adm.Rpt.GestionProduccion {
    ...
    /// </summary>
    public partial class dsrPrecierreOrdenDeProduccionSubRpt : DataDynamics.ActiveReports.ActiveReport {
        #region Variables
        private bool _UseExternalRpx;
        private static string _RpxFileName;
        #endregion //Variables
        #region Constructor
        public dsrPrecierreOrdenDeProduccionSubRpt()
            : this(false, string.Empty) {
        }
        public dsrPrecierreOrdenDeProduccionSubRpt(bool initUseExternalRpx, string initRpxFileName) {
            InitializeComponent();
