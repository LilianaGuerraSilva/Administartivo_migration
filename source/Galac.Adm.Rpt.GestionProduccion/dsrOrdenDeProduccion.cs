...
namespace Galac.Adm.Rpt.GestionProduccion {
    ...
    /// </summary>
    public partial class dsrOrdenDeProduccion : DataDynamics.ActiveReports.ActiveReport {
        #region Variables
        private bool _UseExternalRpx;
        private static string _RpxFileName;
        #endregion //Variables
        #region Constructor
        public dsrOrdenDeProduccion()
            : this(false, string.Empty) {
        }
        public dsrOrdenDeProduccion(bool initUseExternalRpx, string initRpxFileName) {
            InitializeComponent();
