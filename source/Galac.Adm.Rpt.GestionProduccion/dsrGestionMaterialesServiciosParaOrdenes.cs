...
namespace Galac.Adm.Rpt.GestionProduccion {
    ...
    /// </summary>
    public partial class dsrGestionMaterialesServiciosParaOrdenes : DataDynamics.ActiveReports.ActiveReport {
        #region Variables
        private bool _UseExternalRpx;
        private static string _RpxFileName;
        #endregion //Variables
        #region Constructor
        public dsrGestionMaterialesServiciosParaOrdenes()
            : this(false, string.Empty) {
        }

        public dsrGestionMaterialesServiciosParaOrdenes(bool initUseExternalRpx, string initRpxFileName) {
            InitializeComponent();
        ...
        public string ReportTitle() {
            return "Gestión de Materiales/Servicios para iniciar Ordenes";
        }
        ...
        public bool ConfigReport(DataTable valDataSource, Dictionary<string, string> valParameters) {
            ...
            if (LibReport.ConfigDataSource(this, valDataSource)) {
                ...
                LibReport.ConfigFieldDec(this, "txtCantidadAProducirEstimada", string.Empty, "CantidadSolicitada", "n" + 3, true, TextAlignment.Right);
                ...
                LibReport.ConfigFieldDec(this, "txtCantidadReservadaDeInventario", string.Empty, "CantidadReservadaIventario", "n" + 3, true, TextAlignment.Right);
