...
namespace Galac.Adm.Rpt.GestionProduccion {
    ...
    public class clsListaDeMaterialesSalida: LibRptBaseMfc {
        #region Propiedades
        ...
        */
        ...
        public clsListaDeMaterialesSalida(ePrintingDevice initPrintingDevice, eExportFileFormat initExportFileFormat, LibXmlMemInfo initAppMemInfo, LibXmlMFC initMfc,
        ...
        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsListaDeMaterialesSalida.ReportName;
            if (UseExternalRpx) {
        ...
        */
        ...
        public override void SendReportToDevice() {
            ...
            if (vRpt.ConfigReport(Data, vParams)) {
                LibReport.SendReportToDevice(vRpt, 1, PrintingDevice, clsListaDeMaterialesSalida.ReportName, true, ExportFileFormat, "", false);
            }
