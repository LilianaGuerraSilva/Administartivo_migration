...
namespace Galac.Adm.Rpt.GestionProduccion {
    ...
    public class clsPrecierreOrdenDeProduccionRpt : LibRptBaseMfc {
        #region Propiedades
        ...
        */
        ...
        public clsPrecierreOrdenDeProduccionRpt(ePrintingDevice initPrintingDevice, eExportFileFormat initExportFileFormat, LibXmlMemInfo initAppMemInfo, LibXmlMFC initMfc, string iniCodigoOrden, eGeneradoPor iniGeneradoPor, DateTime iniFechaDesde, DateTime iniFechaHasta, eSeleccionarOrdenPor iniSeleccionarOrdenPor)
        ...
        */
        ...
        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsPrecierreOrdenDeProduccionRpt.ReportName;
            if (UseExternalRpx) {
    ...
    } //End of class clsPrecierreOrdenDeProduccionRpt
