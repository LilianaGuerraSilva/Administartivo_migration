...
namespace Galac.Adm.Rpt. GestionProduccion {
    ...
    public class clsCostoProduccionInventarioEntreFechas: LibRptBaseMfc {
        ...
        */
        ...
        public static string ReportName {
            get { return new dsrCostoProduccionInventarioEntreFechas().ReportTitle(); }
        }

        public override Dictionary<string, string> GetConfigReportParameters() {
            string vTitulo = clsCostoProduccionInventarioEntreFechas.ReportName;
            if (UseExternalRpx) {
    ...
    } //End of class clsCostoProduccionInventarioEntreFechas
