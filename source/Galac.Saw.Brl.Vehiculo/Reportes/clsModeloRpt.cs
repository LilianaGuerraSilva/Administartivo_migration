...
namespace Galac.Saw.Brl.Vehiculo.Reportes {
    ...
    public class clsModeloRpt: ILibReportInfo {
        #region Variables
        ...
        public clsModeloRpt() {
            ...
            _PropertiesForReportList.Add("Modelo", ModeloInfo());
        }
        #endregion //Constructores
        #region Metodos Generados

        private Dictionary<string, string> ModeloInfo() {
            Dictionary<string, string> vResult = new Dictionary<string, string>();
            vResult.Add("SpSearchName", "Saw.Gp_ModeloSCH");
