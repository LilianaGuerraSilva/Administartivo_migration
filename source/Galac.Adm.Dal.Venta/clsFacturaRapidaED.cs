...
namespace Galac.Adm.Dal.Venta {
    ...
    public class clsFacturaRapidaED: LibED, ILibMefDalComponent {
        ...
        private string SqlSpUpd() {
            ...
            SQL.AppendLine("      BEGIN");
            SQL.AppendLine("--Para Validaciones de FK Lógicas crear e invocar:DECLARE @CanBeChanged bit; EXEC @CanBeChanged = " + DbSchema + ".Gp_FacturacionRapidaCanBeUpdated @ConsecutivoCompania,@Numero,@TipoDeDocumento, @CurrentTimeStamp, @ValidationMsg out");
        ...
        private string SqlSpDel() {
            ...
            //SQL.AppendLine("      IF (CAST(@CurrentTimeStamp AS bigint) = @TimeStampAsInt)");
            //SQL.AppendLine("      BEGIN");
            //SQL.AppendLine("--Para Validaciones de FK Lógicas crear e invocar:DECLARE @CanBeDeleted bit; EXEC @CanBeDeleted = dbo.Gp_FacturacionRapidaCanBeDeleted @ConsecutivoCompania,@Numero,@TipoDeDocumento, @CurrentTimeStamp, @ValidationMsg out");
