...
namespace Galac.Adm.Brl.GestionCompras.Reportes {
    public class clsOrdenDeCompraSql {
        ...
        public string SqlCompra(int valConsecutivoCompania, int ConsecutivoCompra) {
            ...
            vSql.AppendLine(" , Adm.Gv_OrdenDeCompra_B1.Moneda, Gv_ArticuloInventario_B2.CampoDefinible1, Gv_ArticuloInventario_B2.CampoDefinible2, Gv_ArticuloInventario_B2.CampoDefinible3, Gv_ArticuloInventario_B2.CampoDefinible4, Gv_ArticuloInventario_B2.CampoDefinible5, Gv_ArticuloInventario_B2.UnidadDeVentaSecundaria ");
