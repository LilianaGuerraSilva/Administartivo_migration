...
namespace Galac.Adm.Brl.GestionCompras.Reportes {
    public class clsCompraSql {
        ...
        public string SqlCompra(int valConsecutivoCompania, int ConsecutivoCompra) {
            ...
            vSql.AppendLine(" , ISNULL(Saw.Gv_LoteDeInventario_B1.CodigoLote, '') AS CodigoLote, ISNULL(Saw.Gv_LoteDeInventario_B1.FechaDeElaboracion,'') AS FechaDeElaboracion , ISNULL(Saw.Gv_LoteDeInventario_B1.FechaDeVencimiento, '') AS FechaDeVencimiento, Gv_ArticuloInventario_B2.TipoArticuloInv");            
            ...
            vSql.AppendLine(" LEFT JOIN Saw.Gv_LoteDeInventario_B1 ON Adm.Gv_CompraDetalleArticuloInventario_B1.ConsecutivoCompania = Saw.Gv_LoteDeInventario_B1.ConsecutivoCompania AND Adm.Gv_CompraDetalleArticuloInventario_B1.ConsecutivoLoteDeInventario = Saw.Gv_LoteDeInventario_B1.Consecutivo ");            
