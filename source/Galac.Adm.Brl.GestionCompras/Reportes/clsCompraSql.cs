...
namespace Galac.Adm.Brl.GestionCompras.Reportes {
    public class clsCompraSql {
        ...
        public string SqlCompra(int valConsecutivoCompania, int ConsecutivoCompra) {
            ...
            vSql.AppendLine(" , Saw.Gv_LoteDeInventario_B1.CodigoLote , Saw.Gv_LoteDeInventario_B1.FechaDeElaboracion , Saw.Gv_LoteDeInventario_B1.FechaDeVencimiento, Gv_ArticuloInventario_B2.TipoArticuloInv");            
